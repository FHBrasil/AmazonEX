 ...
 *  
 */
package de.genkpfamily.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GenkpfamilyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GenkpfamilyFulfilmentProcessConstants.PARENT_PROCESS);
