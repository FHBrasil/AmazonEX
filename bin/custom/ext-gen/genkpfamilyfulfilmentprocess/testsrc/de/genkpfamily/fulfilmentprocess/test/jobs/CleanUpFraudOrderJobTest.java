 ...
 *  
 */
package de.genkpfamily.fulfilmentprocess.test.jobs;
...
import de.genkpfamily.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GenkpfamilyFulfilmentProcessConstants.ORDER_PROCESS_NAME;
