 ...
 *  
 */
package de.genkpfamily.core.hmc;
...
/**
 * Provides necessary meta information about the genkpfamilycore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class GenkpfamilyCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(GenkpfamilyCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.genkpfamily.core.hmc.locales";
