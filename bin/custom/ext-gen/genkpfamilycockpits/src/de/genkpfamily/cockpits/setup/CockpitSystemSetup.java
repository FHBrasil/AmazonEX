 ...
 *  
 */
package de.genkpfamily.cockpits.setup;
...
import de.genkpfamily.cockpits.constants.GenkpfamilyCockpitsConstants;
 ...
 */
@SystemSetup(extension = GenkpfamilyCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GenkpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GenkpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GenkpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
