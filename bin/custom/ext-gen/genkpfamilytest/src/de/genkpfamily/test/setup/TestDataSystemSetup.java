 ...
 *  
 */
package de.genkpfamily.test.setup;
...
import de.genkpfamily.test.constants.GenkpfamilyTestConstants;
import de.genkpfamily.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GenkpfamilyTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/genkpfamilytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/genkpfamilytest/import/reviews.impex");
			...
			importImpexFile(context, "/genkpfamilytest/import/cstickets.impex");
		}
	}
}
