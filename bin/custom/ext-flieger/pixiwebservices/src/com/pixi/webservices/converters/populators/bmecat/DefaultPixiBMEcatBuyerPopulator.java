...
public class DefaultPixiBMEcatBuyerPopulator implements Populator<CatalogModel, BMECAT>
{
	private Logger LOG = Logger.getLogger(DefaultPixiBMEcatBuyerPopulator.class);
