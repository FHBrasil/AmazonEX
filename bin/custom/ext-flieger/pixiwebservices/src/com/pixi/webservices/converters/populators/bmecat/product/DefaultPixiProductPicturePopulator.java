...
public class DefaultPixiProductPicturePopulator implements Populator<ProductModel, Article>
{
	private Logger LOG = Logger.getLogger(DefaultPixiProductPicturePopulator.class);
