...
public class DefaultPixiOrderSupplierPopulator implements Populator<OrderModel, Order>
{
	private Logger LOG = Logger.getLogger(DefaultPixiOrderSupplierPopulator.class);
