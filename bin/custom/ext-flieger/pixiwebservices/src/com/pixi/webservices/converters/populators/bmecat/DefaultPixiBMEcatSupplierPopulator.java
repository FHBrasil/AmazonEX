...
public class DefaultPixiBMEcatSupplierPopulator implements Populator<CatalogModel, BMECAT>
{
	private Logger LOG = Logger.getLogger(DefaultPixiBMEcatSupplierPopulator.class);
