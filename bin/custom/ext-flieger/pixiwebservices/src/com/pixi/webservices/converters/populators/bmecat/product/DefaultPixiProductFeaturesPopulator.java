...
public class DefaultPixiProductFeaturesPopulator implements Populator<ProductModel, Article>
{
	private Logger LOG = Logger.getLogger(DefaultPixiProductFeaturesPopulator.class);
