 ...
 * @author jfelipe
 */
public class OrderNumberByOrderNumberExternalPixiApiImporter extends AbstractPixiApiImporter {
     ...
     * @author jfelipe
     */
    private List<IntegerResult> importOrders(List<PixiFunctionParameter> functionParameters)
            throws SOAPResponseErrorException, SOAPException {
        List<IntegerResult> results = new ArrayList<IntegerResult>();
        SOAPMessage request = getPixiSoapApi().buildMessage(
                PixiFunction.GET_ORDER_NUMBER_BY_ORDER_NUMBER_EXTERNAL, functionParameters);
