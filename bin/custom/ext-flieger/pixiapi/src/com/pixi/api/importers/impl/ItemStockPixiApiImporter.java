...
public class ItemStockPixiApiImporter extends AbstractPixiApiImporter {
    ...
    private static final Logger LOG = Logger.getLogger(ItemStockPixiApiImporter.class);
    //
     ...
     * @return
     *         A List of {@link ItemInfoResult} containing the results from Pixi
     *         API
     ...
     */
    @Override
    public List<ItemStockResult> importData(List<PixiFunctionParameter> functionParameters)
    ...
    private List<ItemStockResult> importItemStockResults(
        ...
        SOAPMessage request = getPixiSoapApi().buildMessage(PixiFunction.GET_ITEM_STOCK,
                functionParameters);
                    ...
                    for (int j = 0; j < row.getChildNodes().getLength(); j++) {
                        ...
                        switch (currentTag.getNodeName()) {
                            ...
                            case PHYSICAL_STOCK:
                                ...
                                break;
                            case SUPPLIER_PRICE:
                                double supplierPrice = Double.parseDouble(currentTagValue);
