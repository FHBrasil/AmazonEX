...
public class ItemStockBinsPixiApiImporter extends AbstractPixiApiImporter {
    ...
    private static final Logger LOG = Logger.getLogger(ItemStockBinsPixiApiImporter.class);
    //
     ...
     */
    @Override
    public List<ItemStockBinsResult> importData(List<PixiFunctionParameter> functionParameters)
