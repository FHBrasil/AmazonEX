...
/**
 * This is the extension manager of the Pixiapi extension.
 */
public class PixiapiManager extends GeneratedPixiapiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PixiapiManager.class.getName());
	 ...
	 */
	public static PixiapiManager getInstance()
	{
		return (PixiapiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PixiapiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PixiapiManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PixiapiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PixiapiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PixiapiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
