...
public class OrderHeaderPixiApiImporter extends AbstractPixiApiImporter {
    ...
    private static final Logger LOG = Logger.getLogger(OrderHeaderPixiApiImporter.class);
    //
     ...
     * @author jfelipe
     */
    private List<OrderHeaderResult> importOrderHeader(List<PixiFunctionParameter> functionParameters)
            throws SOAPResponseErrorException, SOAPException {
        ...
        SOAPMessage request = getPixiSoapApi().buildMessage(PixiFunction.GET_ORDER_HEADER,
                functionParameters);
