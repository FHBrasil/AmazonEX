...
public class ChangedOrderLinesPixiApiImporter extends AbstractPixiApiImporter {
    ...
    private static final Logger LOG = Logger.getLogger(ChangedOrderLinesPixiApiImporter.class);
    //
     ...
     * @return
     *         A List of {@link ChangedOrderLinesResult} containing the results from Pixi
     *         API.
     ...
     */
    @Override
    public List<ChangedOrderLinesResult> importData(List<PixiFunctionParameter> functionParameters)
