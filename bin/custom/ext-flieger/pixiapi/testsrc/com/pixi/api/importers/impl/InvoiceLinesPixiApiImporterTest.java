 ...
 */
@UnitTest
public class InvoiceLinesPixiApiImporterTest {

    private InvoiceLinesPixiApiImporter fixture;
    //
    @Rule
    ...
    @Before
    public void setUp() {
        fixture = new InvoiceLinesPixiApiImporter();
    ...
    public void importDataTest() {
        try {
            ...
            //
            List<InvoiceLineResult> results = fixture.importData(parameters);
