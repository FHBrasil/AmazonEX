...
public class SOrderLinePixiApiExporterTest {
    ...
    public void importDataTest() {
        try {
            ...
            paramQuantityNotDelivered.setType(PixiParameterType.QUANTITY_NOT_DELIVERED);
            paramQuantityNotDelivered.setValue(String.valueOf(quantityNotDelivered));
            parameters.add(paramQuantityNotDelivered);
            PixiFunctionParameter paramEstimatedDelivery = new PixiFunctionParameter();
            paramEstimatedDelivery.setType(PixiParameterType.ESTIMATED_DELIVERY);
            ...
            List<SOrderLineResult> results = sorderlinesImporter.importData(paramsTest);
            ...
            Assert.assertEquals("Results quantity not delivered should be the same as sent.",
