...
public class SupplierDeliveryDaysPixiApiImporterTest {
    ...
    private SupplierDeliveryDaysPixiApiImporter fixture;
    //
    @Rule
    ...
    public void importDataTest() {
        try {
            ...
            PixiFunctionParameter param = new PixiFunctionParameter();
            param.setType(PixiParameterType.SUPPLIER_NUMBER);
            param.setValue("HVHA");
