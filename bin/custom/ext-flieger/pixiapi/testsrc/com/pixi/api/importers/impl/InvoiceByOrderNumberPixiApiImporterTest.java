 ...
 */
@UnitTest
public class InvoiceByOrderNumberPixiApiImporterTest {

    private InvoiceByOrderNumberPixiApiImporter fixture;
    //
    @Rule
    ...
    @Before
    public void setUp() {
        fixture = new InvoiceByOrderNumberPixiApiImporter();
