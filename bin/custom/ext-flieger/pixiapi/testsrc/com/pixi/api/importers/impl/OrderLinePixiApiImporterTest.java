 ...
 */
@UnitTest
public class OrderLinePixiApiImporterTest {

    private OrderLinePixiApiImporter fixture;
    //
    @Rule
    ...
    @Before
    public void setUp() {
        fixture = new OrderLinePixiApiImporter();
    ...
    public void importDataTest() {
        try {
            ...
            PixiFunctionParameter paramLineKey = new PixiFunctionParameter();
            paramLineKey.setType(PixiParameterType.ORDER_LINE_KEY);
            paramLineKey.setValue("");
            parameters.add(paramLineKey);
            PixiFunctionParameter paramOrderNumber = new PixiFunctionParameter();
            paramOrderNumber.setType(PixiParameterType.ORDER_NUMBER);
            paramOrderNumber.setValue("100382");
            ...
            paramOrderNumberExternal.setValue("");
            parameters.add(paramOrderNumberExternal);
            //
            List<OrderLineResult> results = fixture.importData(parameters);
