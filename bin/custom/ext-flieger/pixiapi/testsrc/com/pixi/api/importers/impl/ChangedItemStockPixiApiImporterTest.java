 ...
 */
@UnitTest
public class ChangedItemStockPixiApiImporterTest {

    private ChangedItemStockPixiApiImporter fixture;
    ...
    @Before
    public void setUp() {
        fixture = new ChangedItemStockPixiApiImporter();
     ...
     */
    @Test
    public void importDataTest_WrongParameterValue() {
        try {
            List<PixiFunctionParameter> parameters = new ArrayList<PixiFunctionParameter>();
            PixiFunctionParameter paramDate = new PixiFunctionParameter();
            paramDate.setType(PixiParameterType.SINCE_DATE);
            ...
            testDate.set(Calendar.DAY_OF_MONTH, 1);
            testDate.set(Calendar.MONTH, 7);
            testDate.set(Calendar.YEAR, 2100);
            String formattedTestDate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(testDate
                    .getTime());
            paramDate.setValue(formattedTestDate);
            //
            ...
            Assert.assertEquals("Exception should be invalid parameter.",
                    InvalidParameterException.class.getName(), e.getClass().getName());
        }
    }
