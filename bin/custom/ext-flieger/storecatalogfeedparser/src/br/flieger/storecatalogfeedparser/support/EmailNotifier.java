...
public abstract class EmailNotifier implements Notifiable {
    ...
    protected MimeMessage prepareEmail() {
        ...
        Session session = Session.getDefaultInstance(props, new GMailAuthenticator(
                "email.server.teste.local@gmail.com", "33933393"));
    ...
    protected void removeRecipient(final String... recipientsToRemove) {
        outer: for (String recipient : recipientsToRemove) {
