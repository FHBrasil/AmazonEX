...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        <rss version="2.0">
            <channel>
                <title>
                    <xsl:value-of select="products/storeTitle" />
                </title>
                <link>
                    <xsl:value-of select="products/storeUrl" />
                </link>
                <description>
                    <xsl:value-of select="products/storeDescription" />
                    Sociomantic
                </description>
    ...
    <xsl:template match="product">
        ...
        <item>
            ...
            <xsl:for-each select="images/addtional_image">
