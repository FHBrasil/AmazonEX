...
public final class XMLUtils {
    ...
    /**
     * Creates a new XML element, without a prepare delimiter.
     * @param name The XML element name
     * @param content The XML element value
     * @return
     *
     * @author jfelipe
     */
    public <T> Element createElement(final String name, final T content) {
     ...
     */
    public <T> Element createElement(final String name, final T content,
            final boolean prepareDelimiter) {
    ...
    public void copy(final Document src, final Document destiny, final boolean detachRoot) {
        ...
        if (root != null && !src.getContent().isEmpty()) {
            final List content = detachRoot ? src.detachRootElement().cloneContent() : src
                    .cloneContent();
