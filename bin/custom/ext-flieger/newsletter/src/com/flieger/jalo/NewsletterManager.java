...
import com.flieger.constants.NewsletterConstants;



/**
 * This is the extension manager of the Newsletter extension.
 */
public class NewsletterManager extends GeneratedNewsletterManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NewsletterManager.class.getName());
	 ...
	 */
	public static NewsletterManager getInstance()
	{
		return (NewsletterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NewsletterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewsletterManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NewsletterManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NewsletterManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NewsletterManager called, current tenant: " + getTenant().getTenantID());
		}
	}
