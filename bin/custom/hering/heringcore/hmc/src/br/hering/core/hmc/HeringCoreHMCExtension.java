...
/**
 * Provides necessary meta information about the heringcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class HeringCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HeringCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "br.hering.core.hmc.locales";
