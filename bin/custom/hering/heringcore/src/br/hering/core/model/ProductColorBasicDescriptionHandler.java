 ...
 *
 */
public class ProductColorBasicDescriptionHandler extends AbstractFeatureValueHandler<String> implements DynamicAttributeHandler<String, HeringSizeVariantProductModel>
{
	...
	public String get(HeringSizeVariantProductModel product)
	{
		...
		Object featureValue = getFeatureValue(product, "Descrição cor básica");
