 ...
 *
 */
public class ProductColorFullDescriptionHandler extends AbstractFeatureValueHandler<String> implements DynamicAttributeHandler<String, HeringSizeVariantProductModel>
{
