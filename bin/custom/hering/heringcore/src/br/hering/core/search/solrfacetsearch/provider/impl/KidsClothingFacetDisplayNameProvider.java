 ...
 *
 */
public class KidsClothingFacetDisplayNameProvider extends AbstractFacetValueDisplayNameProvider
{
	/* (non-Javadoc)
	...
	public String getDisplayName(final SearchQuery query, final IndexedProperty property, final String facetValue)
	{
		...
		return Boolean.valueOf(facetValue).booleanValue() ?  "Infantil" : "Adulto";
	}
}