...
import br.hering.core.enums.SwatchColorEnum;
...
public class ColorFacetValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	{
		final HeringStyleVariantProductModel heringStyleModel = getHeringStyleProductModel(model);
		if (heringStyleModel == null)
		{
			return Collections.emptyList();
		}

		final Set<SwatchColorEnum> colors = heringStyleModel.getSwatchColors();
	...
	protected HeringStyleVariantProductModel getHeringStyleProductModel(Object model)
	{
		...
		{
			return (HeringStyleVariantProductModel) model;
		}
		else
		{
			return null;
