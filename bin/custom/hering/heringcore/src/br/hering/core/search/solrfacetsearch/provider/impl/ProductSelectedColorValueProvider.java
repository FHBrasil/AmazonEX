 ...
 *
 */
public class ProductSelectedColorValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{
	@Resource
	...
	public Collection<FieldValue> getFieldValues(IndexConfig indexConfig, IndexedProperty indexedProperty, Object model) throws FieldValueProviderException
	{
		...
		final String selectedColor = getFeatureValue((ProductModel) model, "RGB");
		
		final Collection<String> fieldNames = fieldNameProvider.getFieldNames(indexedProperty, null);
		
		for (final String fieldName : fieldNames) 
		{
			values.add(new FieldValue(fieldName, selectedColor));
		}
