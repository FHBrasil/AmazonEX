 ...
 *  
 */
package br.hering.core.batch.task;
...
{
	private static final String APPAREL = "heringProductCatalog";
	...
	public void setUp() throws Exception
	{
		...
		importCsv("/heringcore/test/testBatch.impex", "utf-8");
	...
	public void testBasicProduct() throws Exception
	{
		...
		Assert.assertEquals("heringProductCatalog", product.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testPrice() throws Exception
	{
		...
		try
		{
			...
			Assert.assertEquals("heringProductCatalog", prize.getCatalogVersion().getCatalog().getId());
		}
		finally
		{
	...
	public void testMedia() throws Exception
	{
		...
		Assert.assertEquals("heringProductCatalog", container.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testVariant() throws Exception
	{
		processFile(productId, "base_product-", new ProductContent()
		{
			...
			public void writeContent(final PrintWriter writer) throws IOException
			{
				writer.print("HeringSizeVariantProduct");
		...
		final HeringSizeVariantProductModel variant = (HeringSizeVariantProductModel) productService.getProductForCode(variantId
				.toString());
		Assert.assertEquals("HeringSizeVariantProduct", product.getVariantType().getCode());
	...
	protected void verifyMedia(final MediaModel media, final String format)
	{
		...
		Assert.assertEquals("heringProductCatalog", media.getCatalogVersion().getCatalog().getId());
