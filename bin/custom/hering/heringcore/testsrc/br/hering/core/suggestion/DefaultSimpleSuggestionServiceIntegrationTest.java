 ...
 *  
 */
package br.hering.core.suggestion;
...
import br.hering.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/heringcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
