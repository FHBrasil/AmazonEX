 ...
 *  
 */
package de.fliegersoftware.textboxinfoaddon.hmc;
...
/**
 * Provides necessary meta information about the textboxinfoaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class TextboxinfoaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TextboxinfoaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.fliegersoftware.textboxinfoaddon.hmc.locales";
