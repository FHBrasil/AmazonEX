 ...
 *  
 */
package de.fliegersoftware.textboxinfoaddon.jalo;
...
import de.fliegersoftware.textboxinfoaddon.constants.TextboxinfoaddonConstants;



/**
 * This is the extension manager of the Textboxinfoaddon extension.
 */
public class TextboxinfoaddonManager extends GeneratedTextboxinfoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextboxinfoaddonManager.class.getName());
	 ...
	 */
	public static TextboxinfoaddonManager getInstance()
	{
		return (TextboxinfoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TextboxinfoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextboxinfoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextboxinfoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextboxinfoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TextboxinfoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
