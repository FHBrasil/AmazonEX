 ...
 * generated in the br.hering.webservices.message.stock package. 
...
public class ObjectFactory {
    ...
    private final static QName _CodigoMovimentacao_QNAME = new QName("http://hering.fliegersoftware.de/interface/soap/", "codigoMovimentacao");
    private final static QName _Estoque_QNAME = new QName("http://hering.fliegersoftware.de/interface/soap/", "estoque");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.hering.webservices.message.stock
     * 
     */
    ...
    /**
     * Create an instance of {@link ImportarEstoqueProdutoRequest }
     * 
     */
    public ImportarEstoqueProdutoRequest createImportarEstoqueProdutoRequest() {
        return new ImportarEstoqueProdutoRequest();
    }

    /**
     * Create an instance of {@link EstoqueProduto }
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hering.fliegersoftware.de/interface/soap/", name = "codigoMovimentacao")
    public JAXBElement<String> createCodigoMovimentacao(String value) {
        return new JAXBElement<String>(_CodigoMovimentacao_QNAME, String.class, null, value);
    }
