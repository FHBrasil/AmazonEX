 ...
 *  
 */
package br.hering.webservices.jalo;
...
import br.hering.webservices.constants.HeringwsConstants;



/**
 * This is the extension manager of the Heringws extension.
 */
public class HeringwsManager extends GeneratedHeringwsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HeringwsManager.class.getName());
	 ...
	 */
	public static HeringwsManager getInstance()
	{
		return (HeringwsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HeringwsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HeringwsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HeringwsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HeringwsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HeringwsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
