...
import br.hering.test.constants.HeringTestConstants;
import br.hering.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HeringTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/heringtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/heringtest/import/reviews.impex");
			...
			importImpexFile(context, "/heringtest/import/cstickets.impex");
		}
	}
}
