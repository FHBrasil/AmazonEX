 ...
 *
 */
public interface HeringCheckoutFacade 
extends AcceleratorCheckoutFacade
{
...
//	boolean setPaymentDetails(final HeringDebitPaymentInfoData debitPaymentInfoData);
	...
	HeringDebitPaymentInfoData createPaymentSubscription(final HeringDebitPaymentInfoData paymentInfoData);
