 ...
 *  
 */
package br.hering.facades.flow.impl;
...
public class DefaultCheckoutFlowFacadeTest extends AcceleratorBaseTest
{
	@Resource
	...
	@Test
	public void testGetDefaultFlowForHeringUk()
	{
		new CMSSiteAwareTestExecutor("hering-uk", cmsSiteService)
		{
			@Override
			protected void performTest()
			{
	...
	@Test
	public void testGetDefaultFlowForHeringDe()
	{
		new CMSSiteAwareTestExecutor("hering-de", cmsSiteService)
		{
			@Override
			protected void performTest()
			{
