...
import br.hering.constants.HeringstorefrontcommonsConstants;



/**
 * This is the extension manager of the Heringstorefrontcommons extension.
 */
public class HeringstorefrontcommonsManager extends GeneratedHeringstorefrontcommonsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HeringstorefrontcommonsManager.class.getName());
	 ...
	 */
	public static HeringstorefrontcommonsManager getInstance()
	{
		return (HeringstorefrontcommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HeringstorefrontcommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HeringstorefrontcommonsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HeringstorefrontcommonsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HeringstorefrontcommonsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HeringstorefrontcommonsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
