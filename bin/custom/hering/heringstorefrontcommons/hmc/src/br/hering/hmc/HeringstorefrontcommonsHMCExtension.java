...
/**
 * Provides necessary meta information about the heringstorefrontcommons hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class HeringstorefrontcommonsHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HeringstorefrontcommonsHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "br.hering.hmc.locales";
