...
import br.flieger.exacttarget.events.OrderConfirmedEvent;
import br.hering.fulfilmentprocess.CheckOrderService;
...
public class CheckOrderAction extends AbstractSimpleDecisionAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		if (getCheckOrderService().check(order))
		{
			...
			LOG.info("Disparo do evento de SendEmail");
			orderConfirmedEvent.setOrder(order);
			eventService.publishEvent(orderConfirmedEvent);
