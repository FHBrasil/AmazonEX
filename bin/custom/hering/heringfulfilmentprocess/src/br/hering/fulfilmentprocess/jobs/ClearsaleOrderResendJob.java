...
public class ClearsaleOrderResendJob extends GeneratedClearsaleOrderResendJob
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger( ClearsaleOrderResendJob.class.getName() );
