 ...
 *  
 */
package br.hering.fulfilmentprocess.test.jobs;
...
import br.hering.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = HeringFulfilmentProcessConstants.ORDER_PROCESS_NAME;
