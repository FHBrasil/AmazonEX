 ...
 *  
 */
package br.hering.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HeringFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HeringFulfilmentProcessConstants.PARENT_PROCESS);
