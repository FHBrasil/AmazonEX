...
import br.hering.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction;
...
public class SendFraudErrorNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link br.hering.fulfilmentprocess.actions.order.SendFraudErrorNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
