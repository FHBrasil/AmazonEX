...
import br.hering.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	public String updateCartQuantities(HttpServletRequest request, @RequestParam("storeNamePost") final String storeId,
	...
	@RequestMapping(value = "/cart/update/mini", method = RequestMethod.POST, produces = "application/json")
	public String updateCartQuantitiesMini(@RequestParam("storeNamePost") final String storeId,
			@RequestParam("entryNumber") final long entryNumber, @RequestParam("hiddenPickupQty") final long quantity,
			final RedirectAttributes redirectModel) throws CommerceCartModificationException
	{
		final CartModificationData cartModificationData = cartFacade.updateCartEntry(entryNumber, storeId);
