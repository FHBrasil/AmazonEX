 ...
 *  
 */
package br.hering.storefront.tags;
...
public class Functions
{
	 ...
	 * @return the image
	 */
	public static Collection<ImageData> getImageForProductAndFormat(final ProductData product, final String format)
	{
		if (product != null && format != null)
		{
			final Collection<ImageData> images = product.getImages();
	 ...
	 * @return the image
	 */
	public static Collection<ImageData> getPreviewImageForProductAndFormat(final ProductData product, final String format)
	{
		if (product != null && format != null)
		{
			final Collection<ImageData> images = product.getPreviewImages();
	...
	/**
	 * Utility tag to mask the card number
	...
	public static String getMaskedCardNumber(String cardNumber) 
	{
		...
		{
			String endPortion = cardNumber.trim().substring(cardNumber.length() - 4);
			return "************" + endPortion;
		}
		return null;
	}
