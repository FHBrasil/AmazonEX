...
/**
 */
public interface BeforeControllerHandler extends BeforeControllerHandlerAdaptee {
    /**
     ...
     *             in case of errors
     */
    // boolean beforeController(HttpServletRequest request, HttpServletResponse response,
