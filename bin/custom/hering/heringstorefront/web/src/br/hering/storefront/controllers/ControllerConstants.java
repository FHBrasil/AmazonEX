 ...
 *  
 */
package br.hering.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountPaymentInfoEditPage = "pages/account/accountPaymentInfoEditPage";
				String AccountRegisterPage = "pages/account/accountRegisterPage";
				String AccountFacebookProfileEditPage = "pages/account/accountFacebookProfileEditPage";
			}
			...
			interface Product
			{
				...
				String ProductSizeColor = "pages/product/productSizeColor";
			}

			interface Wishlist
			{
				String PublicWishlistPage = "pages/wishlist/publicWishlistPage";
			}

			interface Boleto
			{
				String BoletoPage = "pages/boleto/boletoPage";
			}
		}
		...
		interface Fragments
		{
			...
			interface Email
			{
				String EmailRequestPopup = "fragments/email/emailRequestPopup";
				String EmailRequestValidationMessage = "fragments/email/emailRequestValidationMessage";
			}
			...
			interface Product
			{
				...
				String OutOfStock = "fragments/product/outOfStock";
			}
		}
	}
}