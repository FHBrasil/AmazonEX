...
import br.hering.storefront.util.CSRFHandlerInterceptor;
import br.hering.storefront.util.CSRFTokenManager;
...
{
	private final String SESSION_CSRF_ATTRIBUTE = "br.hering.storefront.util.CSRFTokenManager.tokenval";
