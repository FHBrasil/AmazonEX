ACC.refinements = {
        ...
        $('a.refinementToggle').each(
                function() {
                    ...
                    $(this).on(
                            "click",
                            function() {
                                var content = $(this).parents('.facet').find(
                                        'div.facetValues');
                                $(this)
                                        .attr(
                                                'title',
    ...
    bindMoreStoresToggles : function() {
        $("a.moreStoresFacetValues").click(
                function(e) {
                    e.preventDefault();
                    
                    $(this).parents('div.allFacetValues').find('li.hidden')
                            .slice(0, 5).removeClass('hidden').first().find(
