...
(function ($, document, window) {
        ...
        $close,
        $groupControls,
        $events = $('<a/>'), // $({}) would be prefered, but there is an
                                // issue with jQuery 1.4.2
        ...
        function appendHTML() {
                if (!$box && document.body) {
                        ...
                        $box = $tag(div).attr({
                                id: colorbox,
                                'class': $.support.opacity === false ? prefix + 'IE' : '', // class
                                                                                            // for
                                                                                            // optional
                                                                                            // IE8
                                                                                            // &
        ...
        function addBindings() {
                function clickHandler(e) {
                        // ignore non-left-mouse-clicks and clicks modified with
                        // ctrl / command, shift, or alt.
                ...
                if ($box) {
                        if (!init) {
                                ...
                                // method from being cached, thereby allowing
                                // them to be redefined on the fly.
                                $next.click(function () {
                                        publicMethod.next();
                                });
                                $prev.click(function () {
                                ...
                                if ($.isFunction($.fn.on)) {
                                        ...
                                        // 1.9, so do not contact me about
                                        // 'live' being removed.
                                        // This is not here for jQuery 1.9, it's
                                        // here for legacy users.
        ...
        publicMethod.position = function (speed, loadedCallback) {
                ...
                $box.dequeue().animate(css, {
                        ...
                        complete: function () {
                                ...
                                // of colorbox to avoid a bug in IE's iframe
                                // implementation.
        ...
        publicMethod.prep = function (object) {
                ...
                .appendTo($loadingBay.show())// content has to be appended to
                                                // the DOM for accurate size
                                                // calculations.
                .css({width: getWidth(), overflow: settings.get('scrolling') ? 'auto' : 'hidden'})
                .css({height: getHeight()})// sets the height independently
                                            // from the width in case the new
                                            // width influences the value of
                                            // height.
                .prependTo($content);
                ...
                // problem where IE miscalculates the width of the parent
                // element as 100% of the document width.
                ...
                callback = function () {
                        ...
                        function removeFilter() { // Needed for IE8 in
                                                    // versions of jQuery prior
                                                    // to 1.7.2
        ...
        function load () {
                ...
                if (settings.get('inline')) {
                        ...
                        setTimeout(function () { // A pause because Opera
                                                    // 10.6+ will sometimes not
