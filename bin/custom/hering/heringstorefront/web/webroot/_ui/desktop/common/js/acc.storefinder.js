ACC.storefinder = {
    ...
    drawMap : function() {
        ...
        if ($('#map_canvas').length != 0) {
            ...
            var centerPoint = new google.maps.LatLng($e.data("latitude"), $e
                    .data("longitude"));
            ...
            ACC.storefinder.map = new google.maps.Map(document
            ...
            if ($e.data("southLatitude")) {
                ...
                store = $e.data('stores');
                this.addStore(store.id, store.latitude, store.longitude,
                        store.name)
            }
        }
    },
    ...
    setMapBouns : function() {
        ...
        var $e = $('#map_canvas');
        var swBounds = new google.maps.LatLng($e.data("southLatitude"), $e
                .data("westLongitude"));
        var neBounds = new google.maps.LatLng($e.data("northLatitude"), $e
                .data("eastLongitude"));
    ...
    addStore : function(i, latitude, longitude, name) {
        var marker = new google.maps.Marker({
            ...
            title : name,
            icon : "http://maps.google.com/mapfiles/marker" + 'ABCDE'.charAt(i)
                    + ".png"
        });
