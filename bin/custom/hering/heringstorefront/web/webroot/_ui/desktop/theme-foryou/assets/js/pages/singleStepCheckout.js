$(document).ready(function() {
	...
	if ($(".add_edit_delivery_address_id").length
			|| $("#checkoutContentPanel").length) {
...
function chaordicOrderConfirmation() {
    if ($("div.orderConfirmationData").length) {
    	var transaction = {
                id : "",
                items : new Array(),
                signature : ""
            ...
            var signature = "";
            transaction.id = $("div.orderConfirmationData ").find(
                    "input.orderID").val();
