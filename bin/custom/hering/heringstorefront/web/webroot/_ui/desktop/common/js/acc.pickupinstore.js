    ...
    bindPickupInStoreClick : function() {
        $(document)
                .on(
                        ...
                        function(e) {
                            var ele = $(this);
                            var productId = "popup_store_pickup_form_"
                                    + $(this).attr('id');
                            ...
                            $
                                    .colorbox({
                                        ...
                                        onComplete : function() {
                                            ...
                                            $(
                                                    "#colorbox #popup_store_pickup_form *")
                                                    .each(
                                                            function() {
                                                                $(this)
                                                                        .attr(
                                            ...
                                            $(
                                                    "#colorbox #popup_store_pickup_form label[data-for=pickupQty]")
                                                    .attr(
                                                            "for",
                                                            ele
                                                                    .attr("data-for"))
                                            $(
                                                    ...
                                                    .removeAttr("data-for")
                                            $(
                                                    "#colorbox  input#locationForSearch")
                                                    .focus()
                                            ...
                                            // set the quantity, if the quantity
                                            // is undefined set the quantity to
                                            // the data-value defined in the jsp
                                            $(
                                                    "#colorbox #" + productId
                                                            + " #pickupQty")
                                                    .attr(
