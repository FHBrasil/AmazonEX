...
//	bindAutoCompleteSearch: function() { // modified
//	    //autocomplete da busca
//	    $('#search #palavra-mini-header, #mini-header #palavra-mini-header').blur(function(){
//	        $(this).parent().find('.search-autocomplete-results').hide();
//	    });
//
//	    $('#search #palavra-mini-header, #mini-header #palavra-mini-header').keyup(function(){
//	        var val = $(this).val();
//
