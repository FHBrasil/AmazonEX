...
<ycommerce:testId code="product_wholeProduct">
    ...
    <div class="info">
        ...
        <div class="tamanhos sizes-box">
            ...
            <ul class="sizeVariantEventHandler">
                ...
                <c:forEach items="${product.sizes}" var="size">
                    <li id="${product.code}-${i}" class="InStock-1"><a>${size}</a></li>
        ...
        <form:form id="addToCartForm${product.code}" action="${addToCartUrl}" method="fpost"
            class="addToCartForm clear_fix">
            <input type="hidden" id="productCodePost" name="productCodePost" value="${product.code}" />
            <%--  					<input type="submit" disabled="disabled" class="addToCartButton add" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:theme code="cart.page.add"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"/> --%>
        ...
        <%--
				<span class="detalhes">
					<a href="${viewMoreUrl}" style="color: #fff">
