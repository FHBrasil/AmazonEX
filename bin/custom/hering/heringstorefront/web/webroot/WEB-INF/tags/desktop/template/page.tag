...
<template:master pageTitle="${pageTitle}" showBV="${showBV}">
    ...
    <jsp:body>
			...
			<div class="${pageType == 'PRODUCTSEARCH' || pageType == 'CATEGORY' || pageType == 'ACCOUNTPAGE' || pageType == 'LOGIN' ? '' : 'container '} ${pageType == 'SINGLESTEPCHECKOUT' ? 'onestep150526' : ''} ${pageType == 'CART' ? 'cart150127' : ''}">
				<%-- 
				<c:if test="${pageType == 'SINGLESTEPCHECKOUT'}">	
