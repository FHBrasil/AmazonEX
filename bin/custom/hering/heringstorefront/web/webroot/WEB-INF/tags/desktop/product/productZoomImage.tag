...
<c:set value="${ycommerce:productImage(product, 'superZoom')}" var="superZoomImage"/>
<c:choose>
...
<img	src="${primaryImage.url}" 
		...
		id = "productZoom" 
		class="cloudzoom" 
		data-cloudzoom="lensClass:'zoom-produto',zoomSizeMode:'zoom',captionSource:'',zoomImage:'${superZoomImage.url}',variableMagnification:false"/>
			</c:when>		
			<c:otherwise>
<img	src="${primaryImage.url}"
