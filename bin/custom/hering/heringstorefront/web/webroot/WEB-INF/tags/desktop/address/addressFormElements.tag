...
<c:if test="${themeName == 'hering' || themeName == 'dzarm' || themeName == 'foryou'}">
	...
	<div class="form-row">
		...
		<a target="_blank" class="nao-sei" href="http://www.buscacep.correios.com.br/servicos/dnec/menuAction.do?Metodo=menuEndereco"><spring:theme code="address.search.dont.know" text="Não sei meu CEP" /></a>	
	</div>
