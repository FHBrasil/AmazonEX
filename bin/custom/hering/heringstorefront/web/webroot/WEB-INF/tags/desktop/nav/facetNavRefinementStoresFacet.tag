...
<c:if test="${not empty facetData.values and false}">
	<div class="facet">
		<div class="facetHead">
				...
				<ycommerce:testId code="facetNav_facet${facetData.name}_links">
					<div class="facetValues">
						<div class="allFacetValues">
							<ul class="facet_block ${facetData.multiSelect ? '' : 'indent'} ${facetData.name eq "Buscar por Size" ? 'color' : 'test'}">
										...
										<c:if test="${facetData.multiSelect}">
											<form action="#" method="get">
												...
												<label class="facet_block-label">
													<div class="facetLabel-${facetValue.name}">
