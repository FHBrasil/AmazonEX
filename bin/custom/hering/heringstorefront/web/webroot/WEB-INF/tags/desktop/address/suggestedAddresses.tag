		...
		<div class="span-13 suggested_address_container">
			...
			<c:forEach var="suggestedAddress" items="${suggestedAddresses}">
				...
				<div class="span-5 suggested_address_submit last">
					<form:form method="post" commandName="heringAddressForm" action="${selectSuggestedAddressUrl}">
						...
						<input id="saveInAddressBook" name="saveInAddressBook" type="hidden" value="true"/>
