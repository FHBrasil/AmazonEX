...
<section id="modal-email-recuperacao">
    <section class="result">
        <header>
            <h1>
                <spring:theme code="forgottenEmail.titleRecovered" />
            </h1>
        </header>
        <p>
            <spring:theme code="forgottenEmail.descriptionRecovered" />
            <b>${email}</b>
        </p>
        <a href="#" onClick="parent.jQuery.fancybox.close();" class="btn btn-red"><spring:theme
                code="forgottenEmail.btnClose" /></a>
    </section>
</section>
