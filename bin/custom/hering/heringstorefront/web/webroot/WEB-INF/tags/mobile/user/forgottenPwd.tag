...
<div data-role="page" data-content-theme="c" data-theme="c" id="forgottenPwd" class="forgottenPwd">
		...
		<div class="item_container">
			...
			<form:form method="post" commandName="forgottenPwdForm">
				...
				<ul class="mFormList" data-split-theme="d" data-theme="d">
					<li>
						<formElement:formInputBox idKey="forgottenPwd.email" labelKey="forgottenPwd.email" path="email" inputCSS="text" mandatory="true" hideInputErrorOnField="true"/>
					</li>
					<li>
