...
<div data-content-theme="d" data-theme="e">
	...
	<form:form method="post" id="heringRegisterForm" commandName="heringRegisterForm" action="${action}" data-ajax="false">
		<common:errors/>
		<ul id="heringRegisterFormList" class="mFormList" data-theme="a" data-content-theme="a">
			<li>
