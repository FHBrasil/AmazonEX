...
<c:url value="/checkout/multi/add-cc-info" var="choosePaymentMethodUrl"/>
		...
		<div class="item_container_holder">
			...
			<div class="item_container">
				<div class="payment_details_left_col">
						<form:form method="post" commandName="kpPaymentDetailsForm" class="create_update_payment_form">
                        ...
                        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
							...
							<div class="payment_details_left_col-billing">
								...
								<div id="newBillingAddressFields">
									...
									<formElement:formInputBox idKey="address.phone" labelKey="address.phone" path="billingAddress.phone" inputCSS="text" mandatory="true" tabindex="18"/>
