...
<%-- UPDATE PASSWORD FOR DZARM STORE --%>
...
<%-- UPDATE PASSWORD FOR HERING STORE --%>
					...
					<div class="right">
						<section id="acc-password-form">
							...
							<form:form action="update-password" method="post" commandName="updatePasswordForm" autocomplete="off">
								...
								<div class="form-row"><formElement:formPasswordBox idKey="profile.currentPassword" labelKey="profile.currentPassword" path="currentPassword" inputCSS="text password" mandatory="true"/></div>
								<div class="form-row"><formElement:formPasswordBox idKey="profile-newPassword" labelKey="profile.newPassword" path="newPassword" inputCSS="text password strength" mandatory="true"/></div>
								<div class="form-row"><formElement:formPasswordBox idKey="profile.checkNewPassword" labelKey="profile.checkNewPassword" path="checkNewPassword" inputCSS="text password" mandatory="true"/></div>
								...
								<div class="btn-group">
									...
									<ycommerce:testId code="profilePage_SaveUpdatePasswordButton">
										<button class="btn btn-confirmar" type="submit"><spring:theme code="text.account.profile.updatePasswordForm" text="Update Password"/></button>
									</ycommerce:testId>
								</div>
							</form:form>
						</section>
