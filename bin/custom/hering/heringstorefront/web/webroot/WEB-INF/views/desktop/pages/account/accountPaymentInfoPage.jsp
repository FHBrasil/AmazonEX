...
<template:page pageTitle="${pageTitle}">
    ...
    <div class="column accountContentPane clearfix">
        <c:url value="/my-account/edit-payment-details" var="encodedUrl" />
        <div class="headline">
                    ...
                    <div class="paymentItem">
                        ...
                        <div class="buttons">
                            <c:if test="${not paymentInfo.defaultPaymentInfo}">
                                ...
                                <form:form
                                        id="setDefaultPaymentDetails${paymentInfo.id}"
                                        action="${setDefaultPaymentActionUrl}"
                                        method="post">
                                    <input type="hidden" name="paymentInfoId"
                                        value="${paymentInfo.id}"/>
                                    <button type="submit" class="submitSetDefault"
                                            id="${paymentInfo.id}" href="#">
                            ...
                            <form:form
                                    id="removePaymentDetails${paymentInfo.id}"
                                    action="${removePaymentActionUrl}"
                                    method="post">
                                <input type="hidden" name="paymentInfoId"
                                        value="${paymentInfo.id}"/>
                                <button type="submit" class="submitRemove"
                                        id="${paymentInfo.id}" href="#">
        ...
        <div class="description" style="clear: both;">
            <a class="button" href="${encodedUrl}">
                <spring:theme code="text.account.paymentDetails.addPaymentMethod"
