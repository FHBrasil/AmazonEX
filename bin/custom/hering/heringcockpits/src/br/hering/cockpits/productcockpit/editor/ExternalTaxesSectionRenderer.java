 ...
 *  
 */
package br.hering.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("heringcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("heringcockpits.product.externalTaxes"));
