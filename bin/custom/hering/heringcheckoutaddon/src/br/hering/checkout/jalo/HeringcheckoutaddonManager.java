 ...
 *  
 */
package br.hering.checkout.jalo;
...
import br.hering.checkout.constants.HeringcheckoutaddonConstants;



/**
 * This is the extension manager of the Heringcheckoutaddon extension.
 */
public class HeringcheckoutaddonManager extends GeneratedHeringcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HeringcheckoutaddonManager.class.getName());
	 ...
	 */
	public static HeringcheckoutaddonManager getInstance()
	{
		return (HeringcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HeringcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HeringcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HeringcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HeringcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HeringcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
