...
<%@ attribute name="voucherPaymentInfo" required="false" type="br.hering.facades.order.data.VoucherPaymentInfoData" %>
...
<div id="checkoutContentPanel" class="revisao-final clearfix summaryFlow">
	...
	<hr>
	<multi-checkout-hering:summaryFlowVoucherPayment voucherPaymentInfo="${voucherPaymentInfo}" paymentModeName="${cartData.paymentMode.name}"/>
</div>