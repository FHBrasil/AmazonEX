    ...
    <section id="general-info">
        <dl class="price-info">
            ...
            <div id="checkoutSubTotals">
                ...
                <dt class="freight"
                    ${not empty cartData.deliveryCost ? '' : 'style=\"display:none;\"'}>
        ...
        <div id="checkoutPaymentTotals">
            <dl class="payment-info">
                <dt class="method">
                    <spring:theme code="checkout.single.details.payment" />
                </dt>
                <dd class="method"></dd>
                <dt class="total">
                    <spring:theme code="checkout.single.details.orderTotal" />
                </dt>
                <dd class="total">
