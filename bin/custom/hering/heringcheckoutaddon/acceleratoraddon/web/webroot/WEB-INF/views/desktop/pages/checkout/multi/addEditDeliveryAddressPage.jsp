...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<multi-checkout-hering:checkoutOrderDetails cartData="${cartData}" showShipDeliveryEntries="true" showPickupDeliveryEntries="true" showTax="false"/>
	
	
	<c:if test="false"> <!-- SPJ Componente Sumário Desabilitado para esta página 02-07-2014 @Willy-->
