...
<div class="paymentDetailsBillingAddress">
    <form:form method="post" commandName="heringBillingAddressForm"
        ...
        <div id="newBillingAddressFields" class="cardForm" style="display: none;">
            ...
            <single-checkout-hering:addressFormElements regions="${regions}" country="${country}"
                page="${page}" />
            ...
            <input type="hidden" name="address.shippingAddress" value="false" /> <input
                type="hidden" name="address.billingAddress" value="true" />
            <div class="form-actions">
                <button
                    class="buttonBillingAddressFormSendForm positive right btn btn-addr-cadastrar"
                    type="button">
