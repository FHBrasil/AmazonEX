...
import de.flieger.constants.EmptyConstants;



/**
 * This is the extension manager of the Empty extension.
 */
public class EmptyManager extends GeneratedEmptyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmptyManager.class.getName());
	 ...
	 */
	public static EmptyManager getInstance()
	{
		return (EmptyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmptyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmptyManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmptyManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmptyManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmptyManager called, current tenant: " + getTenant().getTenantID());
		}
	}
