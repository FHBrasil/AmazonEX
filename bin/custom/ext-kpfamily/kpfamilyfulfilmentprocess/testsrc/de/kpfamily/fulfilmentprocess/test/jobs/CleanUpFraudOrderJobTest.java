 ...
 *  
 */
package de.kpfamily.fulfilmentprocess.test.jobs;
...
import de.kpfamily.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = KpfamilyFulfilmentProcessConstants.ORDER_PROCESS_NAME;
