 ...
 *  
 */
package de.kpfamily.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(KpfamilyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KpfamilyFulfilmentProcessConstants.PARENT_PROCESS);
