 ...
 *
 */
public class SendUpdateOrderEntryBonusFailedNotificationAction extends AbstractProceduralAction<OrderEntryStatusProcessModel>
{
	private static final Logger LOG = Logger.getLogger(SendUpdateOrderEntryBonusFailedNotificationAction.class);
