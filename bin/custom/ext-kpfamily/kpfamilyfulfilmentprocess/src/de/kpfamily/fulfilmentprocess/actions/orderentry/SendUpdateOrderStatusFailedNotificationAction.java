 ...
 *
 */
public class SendUpdateOrderStatusFailedNotificationAction extends AbstractProceduralAction<OrderEntryStatusProcessModel>
{
	private static final Logger LOG = Logger.getLogger(SendUpdateOrderStatusFailedNotificationAction.class);
