...
import de.kpfamily.core.jalo.GeneratedKpfamilycoreManager;



/**
 * This is the extension manager of the Kpfamilycore extension.
 */
public class KpfamilycoreManager extends GeneratedKpfamilycoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KpfamilycoreManager.class.getName());
	 ...
	 */
	public static KpfamilycoreManager getInstance()
	{
		return (KpfamilycoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KpfamilycoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KpfamilycoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KpfamilycoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KpfamilycoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KpfamilycoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
