...
/**
 * Provides necessary meta information about the kpfamilycore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class KpfamilyCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(KpfamilyCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.kpfamily.core.hmc.locales";
