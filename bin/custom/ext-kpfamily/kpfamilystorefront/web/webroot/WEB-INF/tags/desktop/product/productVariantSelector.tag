...
<%--                             <c:url value="${variantStyle.url}" var="productStyleUrl" /> <a --%>
<%--                             href="${productStyleUrl}" class="colorVariant" --%>
<%--                             name="${variantStyle.url}"> <c:if test="${not empty imageData}"> --%>
...
<!--                 <form> -->
<%--                     <label for="Size"><spring:theme code="product.variants.size" /></label> <select --%>
<!--                         id="Size" class="variant-select" disabled="disabled"> -->
...
<%--                                     ${optionsString}&nbsp; --%>
<%--                                     <format:price priceData="${variantSize.priceData}" />&nbsp;&nbsp;${variantSize.stock.stockLevel} --%>
<!--                                 </option> -->
<%--                             </c:forEach> --%>
<%--                         </c:if> --%>
<!--                     </select> -->
...
<%--                     title="<spring:theme code="product.variants.size.guide"/>">&nbsp;</a> --%>
<!--             </div> -->
<%--         </c:if> --%>
<!--     </div> -->
<%-- </c:if> --%>
