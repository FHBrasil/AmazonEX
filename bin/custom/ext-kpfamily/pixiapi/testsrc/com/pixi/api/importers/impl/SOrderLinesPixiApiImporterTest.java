 ...
 */
@UnitTest
public class SOrderLinesPixiApiImporterTest {

    private SOrderLinesPixiApiImporter fixture;
    //
    @Rule
    ...
    @Before
    public void setUp() {
        fixture = new SOrderLinesPixiApiImporter();
