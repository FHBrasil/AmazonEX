...
import de.kpfamily.constants.KpfamilyservicesConstants;
...
public class KpfamilyservicesManager extends GeneratedKpfamilyservicesManager
{
	...
	{
		return (KpfamilyservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KpfamilyservicesConstants.EXTENSIONNAME);
	}
