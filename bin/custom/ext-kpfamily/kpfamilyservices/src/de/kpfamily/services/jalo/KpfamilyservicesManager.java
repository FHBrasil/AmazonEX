 ...
 *
 */
package de.kpfamily.services.jalo;
...
import de.kpfamily.services.constants.KpfamilyservicesConstants;



/**
 * This is the extension manager of the Kpfamilyservices extension.
 */
public class KpfamilyservicesManager extends GeneratedKpfamilyservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KpfamilyservicesManager.class.getName());
	 ...
	 */
	public static KpfamilyservicesManager getInstance()
	{
		return (KpfamilyservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KpfamilyservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KpfamilyservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KpfamilyservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KpfamilyservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KpfamilyservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
