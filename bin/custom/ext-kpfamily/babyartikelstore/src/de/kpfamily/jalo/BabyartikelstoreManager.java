...
/**
 * This is the extension manager of the Babyartikelstore extension.
 */
public class BabyartikelstoreManager extends GeneratedBabyartikelstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BabyartikelstoreManager.class.getName());
	 ...
	 */
	public static BabyartikelstoreManager getInstance()
	{
		return (BabyartikelstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BabyartikelstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BabyartikelstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BabyartikelstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BabyartikelstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BabyartikelstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
