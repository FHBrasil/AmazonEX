 ...
 *  
 */
package de.kpfamily.facades.jalo;
...
import de.kpfamily.facades.constants.KpfamilyfacadesConstants;
import de.kpfamily.facades.jalo.GeneratedKpfamilyfacadesManager;



/**
 * This is the extension manager of the Kpfamilyfacades extension.
 */
public class KpfamilyfacadesManager extends GeneratedKpfamilyfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KpfamilyfacadesManager.class.getName());
	 ...
	 */
	public static KpfamilyfacadesManager getInstance()
	{
		return (KpfamilyfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KpfamilyfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KpfamilyfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KpfamilyfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KpfamilyfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KpfamilyfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
