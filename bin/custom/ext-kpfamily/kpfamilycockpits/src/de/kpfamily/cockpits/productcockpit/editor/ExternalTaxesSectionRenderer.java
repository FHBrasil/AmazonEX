 ...
 *  
 */
package de.kpfamily.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("kpfamilycockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("kpfamilycockpits.product.externalTaxes"));
