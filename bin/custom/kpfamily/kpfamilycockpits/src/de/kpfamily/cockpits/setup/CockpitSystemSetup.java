 ...
 *  
 */
package de.kpfamily.cockpits.setup;
...
import de.kpfamily.cockpits.constants.KpfamilyCockpitsConstants;
 ...
 */
@SystemSetup(extension = KpfamilyCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(KpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(KpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						KpfamilyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/kpfamilycockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
