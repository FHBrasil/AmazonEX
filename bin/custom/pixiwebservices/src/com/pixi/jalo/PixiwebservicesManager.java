...
import com.pixi.constants.PixiwebservicesConstants;



/**
 * This is the extension manager of the Pixiwebservices extension.
 */
public class PixiwebservicesManager extends GeneratedPixiwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PixiwebservicesManager.class.getName());
	 ...
	 */
	public static PixiwebservicesManager getInstance()
	{
		return (PixiwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PixiwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PixiwebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PixiwebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PixiwebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PixiwebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
