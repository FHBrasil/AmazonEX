...
import com.flieger.constants.ClearsaleantifraudeConstants;



/**
 * This is the extension manager of the Clearsaleantifraude extension.
 */
public class ClearsaleantifraudeManager extends GeneratedClearsaleantifraudeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ClearsaleantifraudeManager.class.getName());
	 ...
	 */
	public static ClearsaleantifraudeManager getInstance()
	{
		return (ClearsaleantifraudeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ClearsaleantifraudeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ClearsaleantifraudeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ClearsaleantifraudeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ClearsaleantifraudeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ClearsaleantifraudeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
