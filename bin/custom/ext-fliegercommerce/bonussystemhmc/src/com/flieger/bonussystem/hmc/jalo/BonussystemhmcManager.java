 ...
 *  
 */
package com.flieger.bonussystem.hmc.jalo;
...
import com.flieger.bonussystem.hmc.constants.BonussystemhmcConstants;



/**
 * This is the extension manager of the Bonussystemhmc extension.
 */
public class BonussystemhmcManager extends GeneratedBonussystemhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BonussystemhmcManager.class.getName());
	 ...
	 */
	public static BonussystemhmcManager getInstance()
	{
		return (BonussystemhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BonussystemhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonussystemhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BonussystemhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BonussystemhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BonussystemhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
