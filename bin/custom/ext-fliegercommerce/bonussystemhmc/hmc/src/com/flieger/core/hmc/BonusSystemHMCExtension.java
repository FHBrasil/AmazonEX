...
/**
 * Provides necessary meta information about the bonussystem hmc extension.
 * 
 */
public class BonusSystemHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(BonusSystemHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.flieger.bonussystem.hmc.locales";
