 ...
 *  
 */
package com.fliegersoftware.newslettersubscription.jalo;
...
import com.fliegersoftware.newslettersubscription.constants.NewslettersubscriptionConstants;



/**
 * This is the extension manager of the Newslettersubscription extension.
 */
public class NewslettersubscriptionManager extends GeneratedNewslettersubscriptionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NewslettersubscriptionManager.class.getName());
	 ...
	 */
	public static NewslettersubscriptionManager getInstance()
	{
		return (NewslettersubscriptionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NewslettersubscriptionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewslettersubscriptionManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NewslettersubscriptionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NewslettersubscriptionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NewslettersubscriptionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
