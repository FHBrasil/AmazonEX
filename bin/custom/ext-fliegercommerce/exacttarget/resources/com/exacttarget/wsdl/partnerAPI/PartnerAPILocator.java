...
public class PartnerAPILocator extends org.apache.axis.client.Service implements com.exacttarget.wsdl.partnerAPI.PartnerAPI {
 ...
 */
    ...
    public com.exacttarget.wsdl.partnerAPI.Soap getSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.exacttarget.wsdl.partnerAPI.SoapBindingStub _stub = new com.exacttarget.wsdl.partnerAPI.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.exacttarget.wsdl.partnerAPI.Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.exacttarget.wsdl.partnerAPI.SoapBindingStub _stub = new com.exacttarget.wsdl.partnerAPI.SoapBindingStub(new java.net.URL(Soap_address), this);
                _stub.setPortName(getSoapWSDDServiceName());
                return _stub;
            }
        }
