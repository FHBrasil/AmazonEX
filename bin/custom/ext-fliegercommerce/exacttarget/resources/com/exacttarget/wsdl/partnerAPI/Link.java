...
public class Link  extends com.exacttarget.wsdl.partnerAPI.APIObject  implements java.io.Serializable {
    ...
    private com.exacttarget.wsdl.partnerAPI.TrackingEvent[] subscribers;
    ...
    public Link(
           ...
           com.exacttarget.wsdl.partnerAPI.TrackingEvent[] subscribers) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     * @return subscribers
     */
    public com.exacttarget.wsdl.partnerAPI.TrackingEvent[] getSubscribers() {
        return subscribers;
    }
     ...
     * @param subscribers
     */
    public void setSubscribers(com.exacttarget.wsdl.partnerAPI.TrackingEvent[] subscribers) {
        this.subscribers = subscribers;
    }

    public com.exacttarget.wsdl.partnerAPI.TrackingEvent getSubscribers(int i) {
        return this.subscribers[i];
    }

    public void setSubscribers(int i, com.exacttarget.wsdl.partnerAPI.TrackingEvent _value) {
