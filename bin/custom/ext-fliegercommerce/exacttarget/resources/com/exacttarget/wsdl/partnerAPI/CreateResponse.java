...
public class CreateResponse  implements java.io.Serializable {
    private com.exacttarget.wsdl.partnerAPI.CreateResult[] results;
    ...
    public CreateResponse(
           com.exacttarget.wsdl.partnerAPI.CreateResult[] results,
    ...
    /**
     * Gets the results value for this CreateResponse.
     * 
     * @return results
     */
    public com.exacttarget.wsdl.partnerAPI.CreateResult[] getResults() {
        return results;
    }


    /**
     * Sets the results value for this CreateResponse.
     * 
     * @param results
     */
    public void setResults(com.exacttarget.wsdl.partnerAPI.CreateResult[] results) {
        this.results = results;
    }

    public com.exacttarget.wsdl.partnerAPI.CreateResult getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.exacttarget.wsdl.partnerAPI.CreateResult _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://exacttarget.com/wsdl/partnerAPI", ">CreateResponse"));
