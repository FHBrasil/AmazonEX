...
public class DeleteRequest  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.DeleteOptions options;
    ...
    public DeleteRequest(
           br.flieger.exacttarget.wsdl.api.DeleteOptions options,
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.DeleteOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.DeleteOptions options) {
        this.options = options;
    }
