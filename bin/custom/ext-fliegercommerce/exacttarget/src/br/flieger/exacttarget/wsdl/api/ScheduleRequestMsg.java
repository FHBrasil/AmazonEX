...
public class ScheduleRequestMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ScheduleOptions options;

    private java.lang.String action;

    private br.flieger.exacttarget.wsdl.api.ScheduleDefinition schedule;

    private br.flieger.exacttarget.wsdl.api.APIObject[] interactions;

    public ScheduleRequestMsg() {
    }

    public ScheduleRequestMsg(
           br.flieger.exacttarget.wsdl.api.ScheduleOptions options,
           java.lang.String action,
           br.flieger.exacttarget.wsdl.api.ScheduleDefinition schedule,
           br.flieger.exacttarget.wsdl.api.APIObject[] interactions) {
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.ScheduleOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.ScheduleOptions options) {
        this.options = options;
    }
     ...
     * @return interactions
     */
    public br.flieger.exacttarget.wsdl.api.APIObject[] getInteractions() {
        return interactions;
    }
     ...
     * @param interactions
     */
    public void setInteractions(br.flieger.exacttarget.wsdl.api.APIObject[] interactions) {
        this.interactions = interactions;
    }
