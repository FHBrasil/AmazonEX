...
public class Template  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.ContentArea headerContent;

    private br.flieger.exacttarget.wsdl.api.Layout layout;
    ...
    public Template(
           ...
           br.flieger.exacttarget.wsdl.api.ContentArea headerContent,
           br.flieger.exacttarget.wsdl.api.Layout layout,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ContentArea getHeaderContent() {
        return headerContent;
    }
     ...
     * @param headerContent
     */
    public void setHeaderContent(br.flieger.exacttarget.wsdl.api.ContentArea headerContent) {
        this.headerContent = headerContent;
    }
     ...
     * @return layout
     */
    public br.flieger.exacttarget.wsdl.api.Layout getLayout() {
        return layout;
    }
     ...
     * @param layout
     */
    public void setLayout(br.flieger.exacttarget.wsdl.api.Layout layout) {
        this.layout = layout;
    }
