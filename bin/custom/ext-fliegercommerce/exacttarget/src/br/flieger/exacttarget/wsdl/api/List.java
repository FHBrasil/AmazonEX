...
public class List  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private java.lang.String listName;

    private java.lang.Integer category;

    private br.flieger.exacttarget.wsdl.api.ListTypeEnum type;

    private java.lang.String description;

    private br.flieger.exacttarget.wsdl.api.Subscriber[] subscribers;

    private br.flieger.exacttarget.wsdl.api.ListClassificationEnum listClassification;

    private br.flieger.exacttarget.wsdl.api.Email automatedEmail;
    ...
    public List(
           ...
           br.flieger.exacttarget.wsdl.api.ListTypeEnum type,
           java.lang.String description,
           br.flieger.exacttarget.wsdl.api.Subscriber[] subscribers,
           br.flieger.exacttarget.wsdl.api.ListClassificationEnum listClassification,
           br.flieger.exacttarget.wsdl.api.Email automatedEmail,
     ...
     * @return type
     */
    public br.flieger.exacttarget.wsdl.api.ListTypeEnum getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(br.flieger.exacttarget.wsdl.api.ListTypeEnum type) {
        this.type = type;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ListClassificationEnum getListClassification() {
        return listClassification;
    }
     ...
     */
    public void setListClassification(br.flieger.exacttarget.wsdl.api.ListClassificationEnum listClassification) {
        this.listClassification = listClassification;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.Email getAutomatedEmail() {
        return automatedEmail;
    }
     ...
     */
    public void setAutomatedEmail(br.flieger.exacttarget.wsdl.api.Email automatedEmail) {
        this.automatedEmail = automatedEmail;
    }
