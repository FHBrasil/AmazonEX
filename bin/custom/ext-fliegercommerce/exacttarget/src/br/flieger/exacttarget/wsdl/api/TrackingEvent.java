...
public class TrackingEvent  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.EventType eventType;
     ...
     * @return eventType
     */
    public br.flieger.exacttarget.wsdl.api.EventType getEventType() {
        return eventType;
    }
     ...
     * @param eventType
     */
    public void setEventType(br.flieger.exacttarget.wsdl.api.EventType eventType) {
        this.eventType = eventType;
    }
