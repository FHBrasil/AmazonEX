...
public class Brand  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.BrandTag[] brandTags;
    ...
    public Brand(
           ...
           br.flieger.exacttarget.wsdl.api.BrandTag[] brandTags) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     * @return brandTags
     */
    public br.flieger.exacttarget.wsdl.api.BrandTag[] getBrandTags() {
        return brandTags;
    }
     ...
     * @param brandTags
     */
    public void setBrandTags(br.flieger.exacttarget.wsdl.api.BrandTag[] brandTags) {
        this.brandTags = brandTags;
    }

    public br.flieger.exacttarget.wsdl.api.BrandTag getBrandTags(int i) {
        return this.brandTags[i];
    }

    public void setBrandTags(int i, br.flieger.exacttarget.wsdl.api.BrandTag _value) {
