...
public class ImportDefinitionAutoGenerateDestination  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.DataExtension dataExtensionTarget;
    ...
    public ImportDefinitionAutoGenerateDestination(
           br.flieger.exacttarget.wsdl.api.DataExtension dataExtensionTarget,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.DataExtension getDataExtensionTarget() {
        return dataExtensionTarget;
    }
     ...
     */
    public void setDataExtensionTarget(br.flieger.exacttarget.wsdl.api.DataExtension dataExtensionTarget) {
        this.dataExtensionTarget = dataExtensionTarget;
    }
