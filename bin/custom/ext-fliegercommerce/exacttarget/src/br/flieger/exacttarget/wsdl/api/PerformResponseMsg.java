...
public class PerformResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.PerformResult[] results;
    ...
    public PerformResponseMsg(
           br.flieger.exacttarget.wsdl.api.PerformResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.PerformResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.PerformResult[] results) {
        this.results = results;
    }
