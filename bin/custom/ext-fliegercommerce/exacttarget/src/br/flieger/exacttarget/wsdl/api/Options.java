...
public abstract class Options  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.AsyncResponse[] sendResponseTo;

    private br.flieger.exacttarget.wsdl.api.SaveOption[] saveOptions;
    ...
    private br.flieger.exacttarget.wsdl.api.RequestType requestType;

    private br.flieger.exacttarget.wsdl.api.Priority queuePriority;
     ...
     */
    public br.flieger.exacttarget.wsdl.api.AsyncResponse[] getSendResponseTo() {
        return sendResponseTo;
    }
     ...
     */
    public void setSendResponseTo(br.flieger.exacttarget.wsdl.api.AsyncResponse[] sendResponseTo) {
        this.sendResponseTo = sendResponseTo;
    }

    public br.flieger.exacttarget.wsdl.api.AsyncResponse getSendResponseTo(int i) {
        return this.sendResponseTo[i];
    }

    public void setSendResponseTo(int i, br.flieger.exacttarget.wsdl.api.AsyncResponse _value) {
     ...
     * @return saveOptions
     */
    public br.flieger.exacttarget.wsdl.api.SaveOption[] getSaveOptions() {
        return saveOptions;
    }
     ...
     * @param saveOptions
     */
    public void setSaveOptions(br.flieger.exacttarget.wsdl.api.SaveOption[] saveOptions) {
        this.saveOptions = saveOptions;
    }
     ...
     * @return requestType
     */
    public br.flieger.exacttarget.wsdl.api.RequestType getRequestType() {
        return requestType;
    }
     ...
     * @param requestType
     */
    public void setRequestType(br.flieger.exacttarget.wsdl.api.RequestType requestType) {
        this.requestType = requestType;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.Priority getQueuePriority() {
        return queuePriority;
    }
     ...
     * @param queuePriority
     */
    public void setQueuePriority(br.flieger.exacttarget.wsdl.api.Priority queuePriority) {
        this.queuePriority = queuePriority;
    }
