...
public class Send  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.Link[] links;

    private br.flieger.exacttarget.wsdl.api.TrackingEvent[] events;
    ...
    private br.flieger.exacttarget.wsdl.api.APIObject[] sources;
    ...
    private br.flieger.exacttarget.wsdl.api.EmailSendDefinition emailSendDefinition;

    private br.flieger.exacttarget.wsdl.api.AudienceItem[] suppressionLists;
    ...
    public Send(
           ...
           br.flieger.exacttarget.wsdl.api.Link[] links,
           br.flieger.exacttarget.wsdl.api.TrackingEvent[] events,
           ...
           br.flieger.exacttarget.wsdl.api.APIObject[] sources,
           ...
           br.flieger.exacttarget.wsdl.api.EmailSendDefinition emailSendDefinition,
           br.flieger.exacttarget.wsdl.api.AudienceItem[] suppressionLists) {
        super(
            client,
            partnerKey,
            partnerProperties,
    ...
    public br.flieger.exacttarget.wsdl.api.List getList(int i) {
        return this.list[i];
    }

    public void setList(int i, br.flieger.exacttarget.wsdl.api.List _value) {
        this.list[i] = _value;
    }
     ...
     * @return links
     */
    public br.flieger.exacttarget.wsdl.api.Link[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(br.flieger.exacttarget.wsdl.api.Link[] links) {
        this.links = links;
    }

    public br.flieger.exacttarget.wsdl.api.Link getLinks(int i) {
        return this.links[i];
    }

    public void setLinks(int i, br.flieger.exacttarget.wsdl.api.Link _value) {
        this.links[i] = _value;
    }
     ...
     * @return events
     */
    public br.flieger.exacttarget.wsdl.api.TrackingEvent[] getEvents() {
        return events;
    }
     ...
     * @param events
     */
    public void setEvents(br.flieger.exacttarget.wsdl.api.TrackingEvent[] events) {
        this.events = events;
    }

    public br.flieger.exacttarget.wsdl.api.TrackingEvent getEvents(int i) {
        return this.events[i];
    }

    public void setEvents(int i, br.flieger.exacttarget.wsdl.api.TrackingEvent _value) {
     ...
     * @return sources
     */
    public br.flieger.exacttarget.wsdl.api.APIObject[] getSources() {
        return sources;
    }
     ...
     * @param sources
     */
    public void setSources(br.flieger.exacttarget.wsdl.api.APIObject[] sources) {
        this.sources = sources;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.EmailSendDefinition getEmailSendDefinition() {
        return emailSendDefinition;
    }
     ...
     */
    public void setEmailSendDefinition(br.flieger.exacttarget.wsdl.api.EmailSendDefinition emailSendDefinition) {
        this.emailSendDefinition = emailSendDefinition;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.AudienceItem[] getSuppressionLists() {
        return suppressionLists;
    }
     ...
     */
    public void setSuppressionLists(br.flieger.exacttarget.wsdl.api.AudienceItem[] suppressionLists) {
        this.suppressionLists = suppressionLists;
    }
