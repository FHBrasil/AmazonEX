...
public class AutomationTask  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.AutomationActivity[] activities;
     ...
     * @return activities
     */
    public br.flieger.exacttarget.wsdl.api.AutomationActivity[] getActivities() {
        return activities;
    }
     ...
     * @param activities
     */
    public void setActivities(br.flieger.exacttarget.wsdl.api.AutomationActivity[] activities) {
        this.activities = activities;
    }
