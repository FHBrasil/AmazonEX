...
public class DeleteResponse  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.DeleteResult[] results;
    ...
    public DeleteResponse(
           br.flieger.exacttarget.wsdl.api.DeleteResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.DeleteResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.DeleteResult[] results) {
        this.results = results;
    }

    public br.flieger.exacttarget.wsdl.api.DeleteResult getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, br.flieger.exacttarget.wsdl.api.DeleteResult _value) {
