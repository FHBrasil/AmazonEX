...
public class PlatformApplicationPackage  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ResourceSpecification resourceSpecification;

    private br.flieger.exacttarget.wsdl.api.PublicKeyManagement signingKey;
    ...
    public PlatformApplicationPackage(
           ...
           br.flieger.exacttarget.wsdl.api.PublicKeyManagement signingKey,
     ...
     * @return signingKey
     */
    public br.flieger.exacttarget.wsdl.api.PublicKeyManagement getSigningKey() {
        return signingKey;
    }
     ...
     * @param signingKey
     */
    public void setSigningKey(br.flieger.exacttarget.wsdl.api.PublicKeyManagement signingKey) {
        this.signingKey = signingKey;
    }
