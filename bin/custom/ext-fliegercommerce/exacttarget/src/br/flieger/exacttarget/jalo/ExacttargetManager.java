 ...
 *  
 */
package br.flieger.exacttarget.jalo;
...
import br.flieger.exacttarget.constants.ExacttargetConstants;



/**
 * This is the extension manager of the Exacttarget extension.
 */
public class ExacttargetManager extends GeneratedExacttargetManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ExacttargetManager.class.getName());
	 ...
	 */
	public static ExacttargetManager getInstance()
	{
		return (ExacttargetManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ExacttargetConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ExacttargetManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ExacttargetManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ExacttargetManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ExacttargetManager called, current tenant: " + getTenant().getTenantID());
		}
	}
