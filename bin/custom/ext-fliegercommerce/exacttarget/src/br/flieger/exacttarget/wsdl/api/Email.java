...
public class Email  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.ContentArea[] contentAreas;
    ...
    public Email(
           ...
           br.flieger.exacttarget.wsdl.api.ContentArea[] contentAreas,
     ...
     * @return contentAreas
     */
    public br.flieger.exacttarget.wsdl.api.ContentArea[] getContentAreas() {
        return contentAreas;
    }
     ...
     * @param contentAreas
     */
    public void setContentAreas(br.flieger.exacttarget.wsdl.api.ContentArea[] contentAreas) {
        this.contentAreas = contentAreas;
    }

    public br.flieger.exacttarget.wsdl.api.ContentArea getContentAreas(int i) {
        return this.contentAreas[i];
    }

    public void setContentAreas(int i, br.flieger.exacttarget.wsdl.api.ContentArea _value) {
