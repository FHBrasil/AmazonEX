...
public class ImportDefinitionColumnBasedAction  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.ImportDefinitionColumnBasedActionType action;
    ...
    public ImportDefinitionColumnBasedAction(
           ...
           br.flieger.exacttarget.wsdl.api.ImportDefinitionColumnBasedActionType action) {
           this.value = value;
           this.action = action;
    }
     ...
     * @return action
     */
    public br.flieger.exacttarget.wsdl.api.ImportDefinitionColumnBasedActionType getAction() {
        return action;
    }
     ...
     * @param action
     */
    public void setAction(br.flieger.exacttarget.wsdl.api.ImportDefinitionColumnBasedActionType action) {
        this.action = action;
    }
