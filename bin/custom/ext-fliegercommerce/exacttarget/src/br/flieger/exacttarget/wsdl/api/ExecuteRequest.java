...
public class ExecuteRequest  implements java.io.Serializable {
    ...
    public br.flieger.exacttarget.wsdl.api.APIProperty getParameters(int i) {
        return this.parameters[i];
    }

    public void setParameters(int i, br.flieger.exacttarget.wsdl.api.APIProperty _value) {
