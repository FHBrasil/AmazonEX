...
public class TriggeredSendDefinition  extends br.flieger.exacttarget.wsdl.api.SendDefinition  implements java.io.Serializable {
    /* Always will be set to Continuous. For additional fee, TriggeredSendDefinition.Priority
     * can be used to adjust priority. */
    private br.flieger.exacttarget.wsdl.api.TriggeredSendTypeEnum triggeredSendType;

    private br.flieger.exacttarget.wsdl.api.TriggeredSendStatusEnum triggeredSendStatus;
    ...
    private br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList[] exclusionListCollection;

    private java.lang.String CCEmail;

    private br.flieger.exacttarget.wsdl.api.DataExtension sendSourceDataExtension;
    ...
    public TriggeredSendDefinition(
           ...
           br.flieger.exacttarget.wsdl.api.TriggeredSendTypeEnum triggeredSendType,
           br.flieger.exacttarget.wsdl.api.TriggeredSendStatusEnum triggeredSendStatus,
           ...
           br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList[] exclusionListCollection,
           java.lang.String CCEmail,
           br.flieger.exacttarget.wsdl.api.DataExtension sendSourceDataExtension,
     ...
     * can be used to adjust priority.
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendTypeEnum getTriggeredSendType() {
     ...
     * can be used to adjust priority.
     */
    public void setTriggeredSendType(br.flieger.exacttarget.wsdl.api.TriggeredSendTypeEnum triggeredSendType) {
        this.triggeredSendType = triggeredSendType;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendStatusEnum getTriggeredSendStatus() {
        return triggeredSendStatus;
    }
     ...
     */
    public void setTriggeredSendStatus(br.flieger.exacttarget.wsdl.api.TriggeredSendStatusEnum triggeredSendStatus) {
        this.triggeredSendStatus = triggeredSendStatus;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList[] getExclusionListCollection() {
        return exclusionListCollection;
    }
     ...
     */
    public void setExclusionListCollection(br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList[] exclusionListCollection) {
        this.exclusionListCollection = exclusionListCollection;
    }

    public br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList getExclusionListCollection(int i) {
        return this.exclusionListCollection[i];
    }

    public void setExclusionListCollection(int i, br.flieger.exacttarget.wsdl.api.TriggeredSendExclusionList _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.DataExtension getSendSourceDataExtension() {
        return sendSourceDataExtension;
    }
     ...
     */
    public void setSendSourceDataExtension(br.flieger.exacttarget.wsdl.api.DataExtension sendSourceDataExtension) {
        this.sendSourceDataExtension = sendSourceDataExtension;
    }
