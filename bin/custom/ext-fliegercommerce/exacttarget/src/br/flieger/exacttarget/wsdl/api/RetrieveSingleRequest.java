...
public class RetrieveSingleRequest  extends br.flieger.exacttarget.wsdl.api.Request  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.APIObject requestedObject;

    private br.flieger.exacttarget.wsdl.api.Options retrieveOption;

    public RetrieveSingleRequest() {
    }

    public RetrieveSingleRequest(
           br.flieger.exacttarget.wsdl.api.APIObject requestedObject,
           br.flieger.exacttarget.wsdl.api.Options retrieveOption) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIObject getRequestedObject() {
        return requestedObject;
    }
     ...
     */
    public void setRequestedObject(br.flieger.exacttarget.wsdl.api.APIObject requestedObject) {
        this.requestedObject = requestedObject;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.Options getRetrieveOption() {
        return retrieveOption;
    }
     ...
     */
    public void setRetrieveOption(br.flieger.exacttarget.wsdl.api.Options retrieveOption) {
        this.retrieveOption = retrieveOption;
    }
