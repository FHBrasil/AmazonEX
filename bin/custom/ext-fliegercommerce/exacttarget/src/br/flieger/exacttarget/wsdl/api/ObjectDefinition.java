...
public class ObjectDefinition  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.PropertyDefinition[] properties;

    private br.flieger.exacttarget.wsdl.api.PropertyDefinition[] extendedProperties;

    private br.flieger.exacttarget.wsdl.api.ObjectDefinition[] childObjects;
    ...
    public ObjectDefinition(
           ...
           br.flieger.exacttarget.wsdl.api.PropertyDefinition[] properties,
           br.flieger.exacttarget.wsdl.api.PropertyDefinition[] extendedProperties,
           br.flieger.exacttarget.wsdl.api.ObjectDefinition[] childObjects) {
     ...
     * @return properties
     */
    public br.flieger.exacttarget.wsdl.api.PropertyDefinition[] getProperties() {
        return properties;
    }
     ...
     * @param properties
     */
    public void setProperties(br.flieger.exacttarget.wsdl.api.PropertyDefinition[] properties) {
        this.properties = properties;
    }

    public br.flieger.exacttarget.wsdl.api.PropertyDefinition getProperties(int i) {
        return this.properties[i];
    }

    public void setProperties(int i, br.flieger.exacttarget.wsdl.api.PropertyDefinition _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.PropertyDefinition[] getExtendedProperties() {
        return extendedProperties;
    }
     ...
     */
    public void setExtendedProperties(br.flieger.exacttarget.wsdl.api.PropertyDefinition[] extendedProperties) {
        this.extendedProperties = extendedProperties;
    }
     ...
     * @return childObjects
     */
    public br.flieger.exacttarget.wsdl.api.ObjectDefinition[] getChildObjects() {
        return childObjects;
    }
     ...
     * @param childObjects
     */
    public void setChildObjects(br.flieger.exacttarget.wsdl.api.ObjectDefinition[] childObjects) {
        this.childObjects = childObjects;
    }

    public br.flieger.exacttarget.wsdl.api.ObjectDefinition getChildObjects(int i) {
        return this.childObjects[i];
    }

    public void setChildObjects(int i, br.flieger.exacttarget.wsdl.api.ObjectDefinition _value) {
