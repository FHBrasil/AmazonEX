...
public class SenderProfile  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoForwardTriggeredSend;

    private java.lang.Boolean autoReply;

    private br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoReplyTriggeredSend;
    ...
    private br.flieger.exacttarget.wsdl.api.RecurrenceTypeEnum dataRetentionPeriodUnitOfMeasure;

    private br.flieger.exacttarget.wsdl.api.APIObject replyManagementRuleSet;
    ...
    public SenderProfile(
           ...
           br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoForwardTriggeredSend,
           java.lang.Boolean autoReply,
           br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoReplyTriggeredSend,
           java.lang.String senderHeaderEmailAddress,
           java.lang.String senderHeaderName,
           java.lang.Short dataRetentionPeriodLength,
           br.flieger.exacttarget.wsdl.api.RecurrenceTypeEnum dataRetentionPeriodUnitOfMeasure,
           br.flieger.exacttarget.wsdl.api.APIObject replyManagementRuleSet,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition getAutoForwardTriggeredSend() {
        return autoForwardTriggeredSend;
    }
     ...
     */
    public void setAutoForwardTriggeredSend(br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoForwardTriggeredSend) {
        this.autoForwardTriggeredSend = autoForwardTriggeredSend;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition getAutoReplyTriggeredSend() {
        return autoReplyTriggeredSend;
    }
     ...
     */
    public void setAutoReplyTriggeredSend(br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition autoReplyTriggeredSend) {
        this.autoReplyTriggeredSend = autoReplyTriggeredSend;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.RecurrenceTypeEnum getDataRetentionPeriodUnitOfMeasure() {
        return dataRetentionPeriodUnitOfMeasure;
    }
     ...
     */
    public void setDataRetentionPeriodUnitOfMeasure(br.flieger.exacttarget.wsdl.api.RecurrenceTypeEnum dataRetentionPeriodUnitOfMeasure) {
        this.dataRetentionPeriodUnitOfMeasure = dataRetentionPeriodUnitOfMeasure;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIObject getReplyManagementRuleSet() {
        return replyManagementRuleSet;
    }
     ...
     */
    public void setReplyManagementRuleSet(br.flieger.exacttarget.wsdl.api.APIObject replyManagementRuleSet) {
        this.replyManagementRuleSet = replyManagementRuleSet;
    }
