...
public class EmailSendDefinition  extends br.flieger.exacttarget.wsdl.api.SendDefinition  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.SendDefinitionList[] sendDefinitionList;
    ...
    private br.flieger.exacttarget.wsdl.api.TrackingUser[] trackingUsers;
    ...
    private br.flieger.exacttarget.wsdl.api.MessageDeliveryTypeEnum messageDeliveryType;
    ...
    public EmailSendDefinition(
           ...
           br.flieger.exacttarget.wsdl.api.SendDefinitionList[] sendDefinitionList,
           ...
           br.flieger.exacttarget.wsdl.api.TrackingUser[] trackingUsers,
           java.lang.String additional,
           java.lang.String CCEmail,
           org.apache.axis.types.Time deliveryScheduledTime,
           br.flieger.exacttarget.wsdl.api.MessageDeliveryTypeEnum messageDeliveryType,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.SendDefinitionList[] getSendDefinitionList() {
        return sendDefinitionList;
    }
     ...
     */
    public void setSendDefinitionList(br.flieger.exacttarget.wsdl.api.SendDefinitionList[] sendDefinitionList) {
        this.sendDefinitionList = sendDefinitionList;
    }

    public br.flieger.exacttarget.wsdl.api.SendDefinitionList getSendDefinitionList(int i) {
        return this.sendDefinitionList[i];
    }

    public void setSendDefinitionList(int i, br.flieger.exacttarget.wsdl.api.SendDefinitionList _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TrackingUser[] getTrackingUsers() {
        return trackingUsers;
    }
     ...
     * @param trackingUsers
     */
    public void setTrackingUsers(br.flieger.exacttarget.wsdl.api.TrackingUser[] trackingUsers) {
        this.trackingUsers = trackingUsers;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.MessageDeliveryTypeEnum getMessageDeliveryType() {
        return messageDeliveryType;
    }
     ...
     */
    public void setMessageDeliveryType(br.flieger.exacttarget.wsdl.api.MessageDeliveryTypeEnum messageDeliveryType) {
        this.messageDeliveryType = messageDeliveryType;
    }
