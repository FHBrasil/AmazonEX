...
public class ExtractResult  extends br.flieger.exacttarget.wsdl.api.Result  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ExtractRequest request;
    ...
    public ExtractResult(
           ...
           br.flieger.exacttarget.wsdl.api.ExtractRequest request) {
        super(
            statusCode,
            statusMessage,
            ordinalID,
     ...
     * @return request
     */
    public br.flieger.exacttarget.wsdl.api.ExtractRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(br.flieger.exacttarget.wsdl.api.ExtractRequest request) {
        this.request = request;
    }
