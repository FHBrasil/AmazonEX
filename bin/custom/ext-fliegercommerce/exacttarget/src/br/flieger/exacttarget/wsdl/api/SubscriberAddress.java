...
public class SubscriberAddress  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.AddressStatus[] statuses;
     ...
     * @return statuses
     */
    public br.flieger.exacttarget.wsdl.api.AddressStatus[] getStatuses() {
        return statuses;
    }
     ...
     * @param statuses
     */
    public void setStatuses(br.flieger.exacttarget.wsdl.api.AddressStatus[] statuses) {
        this.statuses = statuses;
    }
