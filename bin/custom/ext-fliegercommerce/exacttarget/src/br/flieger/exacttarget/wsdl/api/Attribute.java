...
public class Attribute  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.CompressionConfiguration compression;
    ...
    public Attribute(
           ...
           br.flieger.exacttarget.wsdl.api.CompressionConfiguration compression) {
           this.name = name;
           this.value = value;
     ...
     * @return compression
     */
    public br.flieger.exacttarget.wsdl.api.CompressionConfiguration getCompression() {
        return compression;
    }
     ...
     * @param compression
     */
    public void setCompression(br.flieger.exacttarget.wsdl.api.CompressionConfiguration compression) {
        this.compression = compression;
    }
