...
public class UpdateRequest  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.UpdateOptions options;
    ...
    public UpdateRequest(
           br.flieger.exacttarget.wsdl.api.UpdateOptions options,
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.UpdateOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.UpdateOptions options) {
        this.options = options;
    }
