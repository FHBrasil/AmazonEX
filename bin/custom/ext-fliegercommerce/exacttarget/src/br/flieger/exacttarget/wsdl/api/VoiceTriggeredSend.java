...
public class VoiceTriggeredSend  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.VoiceTriggeredSendDefinition voiceTriggeredSendDefinition;

    private br.flieger.exacttarget.wsdl.api.Subscriber subscriber;
    ...
    public VoiceTriggeredSend(
           ...
           br.flieger.exacttarget.wsdl.api.VoiceTriggeredSendDefinition voiceTriggeredSendDefinition,
           br.flieger.exacttarget.wsdl.api.Subscriber subscriber,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.VoiceTriggeredSendDefinition getVoiceTriggeredSendDefinition() {
        return voiceTriggeredSendDefinition;
    }
     ...
     */
    public void setVoiceTriggeredSendDefinition(br.flieger.exacttarget.wsdl.api.VoiceTriggeredSendDefinition voiceTriggeredSendDefinition) {
        this.voiceTriggeredSendDefinition = voiceTriggeredSendDefinition;
    }
     ...
     * @return subscriber
     */
    public br.flieger.exacttarget.wsdl.api.Subscriber getSubscriber() {
        return subscriber;
    }
     ...
     * @param subscriber
     */
    public void setSubscriber(br.flieger.exacttarget.wsdl.api.Subscriber subscriber) {
        this.subscriber = subscriber;
    }
