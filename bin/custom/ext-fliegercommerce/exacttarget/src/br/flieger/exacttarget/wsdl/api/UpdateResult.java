...
public class UpdateResult  extends br.flieger.exacttarget.wsdl.api.Result  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.APIObject object;

    private br.flieger.exacttarget.wsdl.api.UpdateResult[] updateResults;
     ...
     */
    public br.flieger.exacttarget.wsdl.api.UpdateResult[] getUpdateResults() {
        return updateResults;
    }
     ...
     * @param updateResults
     */
    public void setUpdateResults(br.flieger.exacttarget.wsdl.api.UpdateResult[] updateResults) {
        this.updateResults = updateResults;
    }

    public br.flieger.exacttarget.wsdl.api.UpdateResult getUpdateResults(int i) {
        return this.updateResults[i];
    }

    public void setUpdateResults(int i, br.flieger.exacttarget.wsdl.api.UpdateResult _value) {
