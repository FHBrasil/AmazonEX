...
public class SaveOption  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.SaveAction saveAction;
    ...
    public SaveOption(
           ...
           br.flieger.exacttarget.wsdl.api.SaveAction saveAction) {
     ...
     * @return saveAction
     */
    public br.flieger.exacttarget.wsdl.api.SaveAction getSaveAction() {
        return saveAction;
    }
     ...
     * @param saveAction
     */
    public void setSaveAction(br.flieger.exacttarget.wsdl.api.SaveAction saveAction) {
        this.saveAction = saveAction;
    }
