...
public class SystemStatusResult  extends br.flieger.exacttarget.wsdl.api.Result  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.SystemStatusType systemStatus;

    private br.flieger.exacttarget.wsdl.api.SystemOutage[] outages;
    ...
    public SystemStatusResult(
           ...
           br.flieger.exacttarget.wsdl.api.SystemStatusType systemStatus,
           br.flieger.exacttarget.wsdl.api.SystemOutage[] outages) {
        super(
            statusCode,
            statusMessage,
            ordinalID,
     ...
     * @return systemStatus
     */
    public br.flieger.exacttarget.wsdl.api.SystemStatusType getSystemStatus() {
        return systemStatus;
    }
     ...
     * @param systemStatus
     */
    public void setSystemStatus(br.flieger.exacttarget.wsdl.api.SystemStatusType systemStatus) {
        this.systemStatus = systemStatus;
    }
     ...
     * @return outages
     */
    public br.flieger.exacttarget.wsdl.api.SystemOutage[] getOutages() {
        return outages;
    }
     ...
     * @param outages
     */
    public void setOutages(br.flieger.exacttarget.wsdl.api.SystemOutage[] outages) {
        this.outages = outages;
    }
