...
public class AsyncResponse  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.AsyncResponseType responseType;

    private java.lang.String responseAddress;

    private br.flieger.exacttarget.wsdl.api.RespondWhen respondWhen;
    ...
    public AsyncResponse(
           br.flieger.exacttarget.wsdl.api.AsyncResponseType responseType,
           java.lang.String responseAddress,
           br.flieger.exacttarget.wsdl.api.RespondWhen respondWhen,
     ...
     * @return responseType
     */
    public br.flieger.exacttarget.wsdl.api.AsyncResponseType getResponseType() {
        return responseType;
    }
     ...
     * @param responseType
     */
    public void setResponseType(br.flieger.exacttarget.wsdl.api.AsyncResponseType responseType) {
        this.responseType = responseType;
    }
     ...
     * @return respondWhen
     */
    public br.flieger.exacttarget.wsdl.api.RespondWhen getRespondWhen() {
        return respondWhen;
    }
     ...
     * @param respondWhen
     */
    public void setRespondWhen(br.flieger.exacttarget.wsdl.api.RespondWhen respondWhen) {
        this.respondWhen = respondWhen;
    }
