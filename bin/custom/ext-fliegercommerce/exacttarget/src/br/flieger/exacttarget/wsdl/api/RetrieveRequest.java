...
public class RetrieveRequest  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ClientID[] clientIDs;
    ...
    private br.flieger.exacttarget.wsdl.api.AsyncResponse[] respondTo;

    private br.flieger.exacttarget.wsdl.api.APIProperty[] partnerProperties;
    ...
    private br.flieger.exacttarget.wsdl.api.Request[] retrieves;

    private br.flieger.exacttarget.wsdl.api.RetrieveOptions options;

    public RetrieveRequest() {
    }

    public RetrieveRequest(
           br.flieger.exacttarget.wsdl.api.ClientID[] clientIDs,
           java.lang.String objectType,
           java.lang.String[] properties,
           br.flieger.exacttarget.wsdl.api.FilterPart filter,
           br.flieger.exacttarget.wsdl.api.AsyncResponse[] respondTo,
           ...
           br.flieger.exacttarget.wsdl.api.Request[] retrieves,
           br.flieger.exacttarget.wsdl.api.RetrieveOptions options) {
     ...
     * @return clientIDs
     */
    public br.flieger.exacttarget.wsdl.api.ClientID[] getClientIDs() {
        return clientIDs;
    }
     ...
     * @param clientIDs
     */
    public void setClientIDs(br.flieger.exacttarget.wsdl.api.ClientID[] clientIDs) {
        this.clientIDs = clientIDs;
    }

    public br.flieger.exacttarget.wsdl.api.ClientID getClientIDs(int i) {
        return this.clientIDs[i];
    }

    public void setClientIDs(int i, br.flieger.exacttarget.wsdl.api.ClientID _value) {
     ...
     * @return respondTo
     */
    public br.flieger.exacttarget.wsdl.api.AsyncResponse[] getRespondTo() {
        return respondTo;
    }
     ...
     * @param respondTo
     */
    public void setRespondTo(br.flieger.exacttarget.wsdl.api.AsyncResponse[] respondTo) {
        this.respondTo = respondTo;
    }

    public br.flieger.exacttarget.wsdl.api.AsyncResponse getRespondTo(int i) {
        return this.respondTo[i];
    }

    public void setRespondTo(int i, br.flieger.exacttarget.wsdl.api.AsyncResponse _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIProperty[] getPartnerProperties() {
        return partnerProperties;
    }
     ...
     */
    public void setPartnerProperties(br.flieger.exacttarget.wsdl.api.APIProperty[] partnerProperties) {
        this.partnerProperties = partnerProperties;
    }

    public br.flieger.exacttarget.wsdl.api.APIProperty getPartnerProperties(int i) {
        return this.partnerProperties[i];
    }

    public void setPartnerProperties(int i, br.flieger.exacttarget.wsdl.api.APIProperty _value) {
     ...
     * @return retrieves
     */
    public br.flieger.exacttarget.wsdl.api.Request[] getRetrieves() {
        return retrieves;
    }
     ...
     * @param retrieves
     */
    public void setRetrieves(br.flieger.exacttarget.wsdl.api.Request[] retrieves) {
        this.retrieves = retrieves;
    }
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.RetrieveOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.RetrieveOptions options) {
        this.options = options;
    }
