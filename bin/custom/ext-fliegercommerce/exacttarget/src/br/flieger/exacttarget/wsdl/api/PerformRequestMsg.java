...
public class PerformRequestMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.PerformOptions options;

    private java.lang.String action;

    private br.flieger.exacttarget.wsdl.api.APIObject[] definitions;

    public PerformRequestMsg() {
    }

    public PerformRequestMsg(
           br.flieger.exacttarget.wsdl.api.PerformOptions options,
           java.lang.String action,
           br.flieger.exacttarget.wsdl.api.APIObject[] definitions) {
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.PerformOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.PerformOptions options) {
        this.options = options;
    }
     ...
     * @return definitions
     */
    public br.flieger.exacttarget.wsdl.api.APIObject[] getDefinitions() {
        return definitions;
    }
     ...
     * @param definitions
     */
    public void setDefinitions(br.flieger.exacttarget.wsdl.api.APIObject[] definitions) {
        this.definitions = definitions;
    }
