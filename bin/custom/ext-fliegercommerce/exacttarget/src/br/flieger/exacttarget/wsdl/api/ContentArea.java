...
public class ContentArea  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.LayoutType layout;
    ...
    public ContentArea(
           ...
           br.flieger.exacttarget.wsdl.api.LayoutType layout,
     ...
     * @return layout
     */
    public br.flieger.exacttarget.wsdl.api.LayoutType getLayout() {
        return layout;
    }
     ...
     * @param layout
     */
    public void setLayout(br.flieger.exacttarget.wsdl.api.LayoutType layout) {
        this.layout = layout;
    }
