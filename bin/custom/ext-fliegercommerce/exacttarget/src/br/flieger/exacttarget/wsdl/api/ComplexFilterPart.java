...
public class ComplexFilterPart  extends br.flieger.exacttarget.wsdl.api.FilterPart  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.FilterPart leftOperand;

    private br.flieger.exacttarget.wsdl.api.LogicalOperators logicalOperator;

    private br.flieger.exacttarget.wsdl.api.FilterPart rightOperand;

    private br.flieger.exacttarget.wsdl.api.FilterPart[] additionalOperands;

    public ComplexFilterPart() {
    }

    public ComplexFilterPart(
           br.flieger.exacttarget.wsdl.api.FilterPart leftOperand,
           br.flieger.exacttarget.wsdl.api.LogicalOperators logicalOperator,
           br.flieger.exacttarget.wsdl.api.FilterPart rightOperand,
           br.flieger.exacttarget.wsdl.api.FilterPart[] additionalOperands) {
     ...
     * @return leftOperand
     */
    public br.flieger.exacttarget.wsdl.api.FilterPart getLeftOperand() {
        return leftOperand;
    }
     ...
     * @param leftOperand
     */
    public void setLeftOperand(br.flieger.exacttarget.wsdl.api.FilterPart leftOperand) {
        this.leftOperand = leftOperand;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.LogicalOperators getLogicalOperator() {
        return logicalOperator;
    }
     ...
     */
    public void setLogicalOperator(br.flieger.exacttarget.wsdl.api.LogicalOperators logicalOperator) {
        this.logicalOperator = logicalOperator;
    }
     ...
     * @return rightOperand
     */
    public br.flieger.exacttarget.wsdl.api.FilterPart getRightOperand() {
        return rightOperand;
    }
     ...
     * @param rightOperand
     */
    public void setRightOperand(br.flieger.exacttarget.wsdl.api.FilterPart rightOperand) {
        this.rightOperand = rightOperand;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.FilterPart[] getAdditionalOperands() {
        return additionalOperands;
    }
     ...
     */
    public void setAdditionalOperands(br.flieger.exacttarget.wsdl.api.FilterPart[] additionalOperands) {
        this.additionalOperands = additionalOperands;
    }
