...
public class ScheduleResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ScheduleResult[] results;
    ...
    public ScheduleResponseMsg(
           br.flieger.exacttarget.wsdl.api.ScheduleResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.ScheduleResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.ScheduleResult[] results) {
        this.results = results;
    }
