...
public class SystemStatusRequestMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.SystemStatusOptions options;

    public SystemStatusRequestMsg() {
    }

    public SystemStatusRequestMsg(
           br.flieger.exacttarget.wsdl.api.SystemStatusOptions options) {
     ...
     * @return options
     */
    public br.flieger.exacttarget.wsdl.api.SystemStatusOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.flieger.exacttarget.wsdl.api.SystemStatusOptions options) {
        this.options = options;
    }
