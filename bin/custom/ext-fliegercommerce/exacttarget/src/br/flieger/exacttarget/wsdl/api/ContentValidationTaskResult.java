...
public class ContentValidationTaskResult  extends br.flieger.exacttarget.wsdl.api.TaskResult  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ValidationResult[] validationResults;
    ...
    public ContentValidationTaskResult(
           ...
           br.flieger.exacttarget.wsdl.api.ValidationResult[] validationResults) {
        super(
            statusCode,
            statusMessage,
            ordinalID,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ValidationResult[] getValidationResults() {
        return validationResults;
    }
     ...
     */
    public void setValidationResults(br.flieger.exacttarget.wsdl.api.ValidationResult[] validationResults) {
        this.validationResults = validationResults;
    }
