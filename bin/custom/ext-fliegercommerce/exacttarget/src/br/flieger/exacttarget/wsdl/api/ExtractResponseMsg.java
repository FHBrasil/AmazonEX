...
public class ExtractResponseMsg  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.ExtractResult[] results;
    ...
    public ExtractResponseMsg(
           ...
           br.flieger.exacttarget.wsdl.api.ExtractResult[] results) {
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.ExtractResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.ExtractResult[] results) {
        this.results = results;
    }

    public br.flieger.exacttarget.wsdl.api.ExtractResult getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, br.flieger.exacttarget.wsdl.api.ExtractResult _value) {
