...
public class QueryObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.QueryObject[] objects;
    ...
    public QueryObject(
           ...
           br.flieger.exacttarget.wsdl.api.QueryObject[] objects) {
     ...
     * @return objects
     */
    public br.flieger.exacttarget.wsdl.api.QueryObject[] getObjects() {
        return objects;
    }
     ...
     * @param objects
     */
    public void setObjects(br.flieger.exacttarget.wsdl.api.QueryObject[] objects) {
        this.objects = objects;
    }

    public br.flieger.exacttarget.wsdl.api.QueryObject getObjects(int i) {
        return this.objects[i];
    }

    public void setObjects(int i, br.flieger.exacttarget.wsdl.api.QueryObject _value) {
