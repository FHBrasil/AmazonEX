...
public class RetrieveRequestMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.RetrieveRequest retrieveRequest;

    public RetrieveRequestMsg() {
    }

    public RetrieveRequestMsg(
           br.flieger.exacttarget.wsdl.api.RetrieveRequest retrieveRequest) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.RetrieveRequest getRetrieveRequest() {
        return retrieveRequest;
    }
     ...
     */
    public void setRetrieveRequest(br.flieger.exacttarget.wsdl.api.RetrieveRequest retrieveRequest) {
        this.retrieveRequest = retrieveRequest;
    }
