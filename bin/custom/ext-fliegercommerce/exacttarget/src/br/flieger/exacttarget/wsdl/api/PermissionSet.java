...
public class PermissionSet  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.PermissionSet[] permissionSets;

    private br.flieger.exacttarget.wsdl.api.Permission[] permissions;
    ...
    public PermissionSet(
           ...
           br.flieger.exacttarget.wsdl.api.PermissionSet[] permissionSets,
           br.flieger.exacttarget.wsdl.api.Permission[] permissions) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.PermissionSet[] getPermissionSets() {
        return permissionSets;
    }
     ...
     */
    public void setPermissionSets(br.flieger.exacttarget.wsdl.api.PermissionSet[] permissionSets) {
        this.permissionSets = permissionSets;
    }
     ...
     * @return permissions
     */
    public br.flieger.exacttarget.wsdl.api.Permission[] getPermissions() {
        return permissions;
    }
     ...
     * @param permissions
     */
    public void setPermissions(br.flieger.exacttarget.wsdl.api.Permission[] permissions) {
        this.permissions = permissions;
    }
