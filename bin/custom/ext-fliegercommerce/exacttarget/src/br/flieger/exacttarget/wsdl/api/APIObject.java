...
public class APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.Owner owner;
     ...
     * @return owner
     */
    public br.flieger.exacttarget.wsdl.api.Owner getOwner() {
        return owner;
    }
     ...
     * @param owner
     */
    public void setOwner(br.flieger.exacttarget.wsdl.api.Owner owner) {
        this.owner = owner;
    }
