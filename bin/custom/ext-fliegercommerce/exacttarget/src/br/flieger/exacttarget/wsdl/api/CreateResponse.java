...
public class CreateResponse  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.CreateResult[] results;
    ...
    public CreateResponse(
           br.flieger.exacttarget.wsdl.api.CreateResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.CreateResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.CreateResult[] results) {
        this.results = results;
    }

    public br.flieger.exacttarget.wsdl.api.CreateResult getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, br.flieger.exacttarget.wsdl.api.CreateResult _value) {
