...
public class VersionInfoResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.VersionInfoResponse versionInfo;
    ...
    public VersionInfoResponseMsg(
           br.flieger.exacttarget.wsdl.api.VersionInfoResponse versionInfo,
     ...
     * @return versionInfo
     */
    public br.flieger.exacttarget.wsdl.api.VersionInfoResponse getVersionInfo() {
        return versionInfo;
    }
     ...
     * @param versionInfo
     */
    public void setVersionInfo(br.flieger.exacttarget.wsdl.api.VersionInfoResponse versionInfo) {
        this.versionInfo = versionInfo;
    }
