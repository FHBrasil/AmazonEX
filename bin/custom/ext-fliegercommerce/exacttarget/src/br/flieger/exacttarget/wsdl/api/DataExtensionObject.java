...
public class DataExtensionObject  extends br.flieger.exacttarget.wsdl.api.ObjectExtension  implements java.io.Serializable {
    private java.lang.String name;

    private br.flieger.exacttarget.wsdl.api.APIProperty[] keys;
    ...
    public DataExtensionObject(
           ...
           br.flieger.exacttarget.wsdl.api.APIProperty[] keys) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     * @return keys
     */
    public br.flieger.exacttarget.wsdl.api.APIProperty[] getKeys() {
        return keys;
    }
     ...
     * @param keys
     */
    public void setKeys(br.flieger.exacttarget.wsdl.api.APIProperty[] keys) {
        this.keys = keys;
    }
