...
public class ValidationAction  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.APIProperty[] validationOptions;
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIProperty[] getValidationOptions() {
        return validationOptions;
    }
     ...
     */
    public void setValidationOptions(br.flieger.exacttarget.wsdl.api.APIProperty[] validationOptions) {
        this.validationOptions = validationOptions;
    }
