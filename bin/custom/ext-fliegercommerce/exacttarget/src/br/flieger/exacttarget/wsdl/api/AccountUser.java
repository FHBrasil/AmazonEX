...
public class AccountUser  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.UserAccess[] userPermissions;
    ...
    private br.flieger.exacttarget.wsdl.api.BusinessUnit defaultBusinessUnitObject;

    private br.flieger.exacttarget.wsdl.api.BusinessUnit[] associatedBusinessUnits;

    private br.flieger.exacttarget.wsdl.api.Role[] roles;

    private br.flieger.exacttarget.wsdl.api.Locale languageLocale;

    private br.flieger.exacttarget.wsdl.api.SsoIdentity[] ssoIdentities;
    ...
    public AccountUser(
           ...
           br.flieger.exacttarget.wsdl.api.UserAccess[] userPermissions,
           int delete,
           ...
           br.flieger.exacttarget.wsdl.api.BusinessUnit defaultBusinessUnitObject,
           br.flieger.exacttarget.wsdl.api.BusinessUnit[] associatedBusinessUnits,
           br.flieger.exacttarget.wsdl.api.Role[] roles,
           br.flieger.exacttarget.wsdl.api.Locale languageLocale,
           br.flieger.exacttarget.wsdl.api.SsoIdentity[] ssoIdentities) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.UserAccess[] getUserPermissions() {
        return userPermissions;
    }
     ...
     */
    public void setUserPermissions(br.flieger.exacttarget.wsdl.api.UserAccess[] userPermissions) {
        this.userPermissions = userPermissions;
    }

    public br.flieger.exacttarget.wsdl.api.UserAccess getUserPermissions(int i) {
        return this.userPermissions[i];
    }

    public void setUserPermissions(int i, br.flieger.exacttarget.wsdl.api.UserAccess _value) {
     ...
     * @param timeZone
     */
    public void setTimeZone(br.flieger.exacttarget.wsdl.api.TimeZone timeZone) {
        this.timeZone = timeZone;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.BusinessUnit getDefaultBusinessUnitObject() {
        return defaultBusinessUnitObject;
    }
     ...
     */
    public void setDefaultBusinessUnitObject(br.flieger.exacttarget.wsdl.api.BusinessUnit defaultBusinessUnitObject) {
        this.defaultBusinessUnitObject = defaultBusinessUnitObject;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.BusinessUnit[] getAssociatedBusinessUnits() {
        return associatedBusinessUnits;
    }
     ...
     */
    public void setAssociatedBusinessUnits(br.flieger.exacttarget.wsdl.api.BusinessUnit[] associatedBusinessUnits) {
        this.associatedBusinessUnits = associatedBusinessUnits;
    }
     ...
     * @param roles
     */
    public void setRoles(br.flieger.exacttarget.wsdl.api.Role[] roles) {
        this.roles = roles;
    }
     ...
     */
    public void setLanguageLocale(br.flieger.exacttarget.wsdl.api.Locale languageLocale) {
        this.languageLocale = languageLocale;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.SsoIdentity[] getSsoIdentities() {
        return ssoIdentities;
    }
     ...
     * @param ssoIdentities
     */
    public void setSsoIdentities(br.flieger.exacttarget.wsdl.api.SsoIdentity[] ssoIdentities) {
        this.ssoIdentities = ssoIdentities;
    }
