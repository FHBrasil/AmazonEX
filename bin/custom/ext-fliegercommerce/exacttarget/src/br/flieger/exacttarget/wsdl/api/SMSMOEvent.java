...
public class SMSMOEvent  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.BaseMOKeyword keyword;
    ...
    public SMSMOEvent(
           ...
           br.flieger.exacttarget.wsdl.api.BaseMOKeyword keyword,
     ...
     * @return keyword
     */
    public br.flieger.exacttarget.wsdl.api.BaseMOKeyword getKeyword() {
        return keyword;
    }
     ...
     * @param keyword
     */
    public void setKeyword(br.flieger.exacttarget.wsdl.api.BaseMOKeyword keyword) {
        this.keyword = keyword;
    }
