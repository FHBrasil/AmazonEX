...
public class PropertyDefinition  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.SoapType valueType;

    /* ExactTarget data type of the property */
    private br.flieger.exacttarget.wsdl.api.PropertyType propertyType;
    ...
    private br.flieger.exacttarget.wsdl.api.AttributeMap[] attributeMaps;

    /* Deprecated. */
    private br.flieger.exacttarget.wsdl.api.APIProperty[] markups;
    ...
    private br.flieger.exacttarget.wsdl.api.PicklistItem[] picklistItems;
    ...
    private br.flieger.exacttarget.wsdl.api.APIObject[] references;
     ...
     */
    public br.flieger.exacttarget.wsdl.api.SoapType getValueType() {
        return valueType;
    }
     ...
     */
    public void setValueType(br.flieger.exacttarget.wsdl.api.SoapType valueType) {
        this.valueType = valueType;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.PropertyType getPropertyType() {
        return propertyType;
    }
     ...
     */
    public void setPropertyType(br.flieger.exacttarget.wsdl.api.PropertyType propertyType) {
        this.propertyType = propertyType;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.AttributeMap[] getAttributeMaps() {
        return attributeMaps;
    }
     ...
     * @param attributeMaps
     */
    public void setAttributeMaps(br.flieger.exacttarget.wsdl.api.AttributeMap[] attributeMaps) {
        this.attributeMaps = attributeMaps;
    }

    public br.flieger.exacttarget.wsdl.api.AttributeMap getAttributeMaps(int i) {
        return this.attributeMaps[i];
    }

    public void setAttributeMaps(int i, br.flieger.exacttarget.wsdl.api.AttributeMap _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIProperty[] getMarkups() {
        return markups;
    }
     ...
     */
    public void setMarkups(br.flieger.exacttarget.wsdl.api.APIProperty[] markups) {
        this.markups = markups;
    }

    public br.flieger.exacttarget.wsdl.api.APIProperty getMarkups(int i) {
        return this.markups[i];
    }

    public void setMarkups(int i, br.flieger.exacttarget.wsdl.api.APIProperty _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.PicklistItem[] getPicklistItems() {
     ...
     */
    public void setPicklistItems(br.flieger.exacttarget.wsdl.api.PicklistItem[] picklistItems) {
        this.picklistItems = picklistItems;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.APIObject[] getReferences() {
        return references;
    }
     ...
     */
    public void setReferences(br.flieger.exacttarget.wsdl.api.APIObject[] references) {
        this.references = references;
    }
