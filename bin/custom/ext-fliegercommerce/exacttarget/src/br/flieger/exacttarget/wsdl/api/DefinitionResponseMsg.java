...
public class DefinitionResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ObjectDefinition[] objectDefinition;
    ...
    public DefinitionResponseMsg(
           br.flieger.exacttarget.wsdl.api.ObjectDefinition[] objectDefinition,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ObjectDefinition[] getObjectDefinition() {
        return objectDefinition;
    }
     ...
     */
    public void setObjectDefinition(br.flieger.exacttarget.wsdl.api.ObjectDefinition[] objectDefinition) {
        this.objectDefinition = objectDefinition;
    }

    public br.flieger.exacttarget.wsdl.api.ObjectDefinition getObjectDefinition(int i) {
        return this.objectDefinition[i];
    }

    public void setObjectDefinition(int i, br.flieger.exacttarget.wsdl.api.ObjectDefinition _value) {
