...
public class DataExtension  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.DataExtensionField sendableDataExtensionField;

    private br.flieger.exacttarget.wsdl.api.Attribute sendableSubscriberField;

    private br.flieger.exacttarget.wsdl.api.DataExtensionTemplate template;
    ...
    private br.flieger.exacttarget.wsdl.api.DataExtensionField[] fields;

    private br.flieger.exacttarget.wsdl.api.DateTimeUnitOfMeasure dataRetentionPeriod;
    ...
    public DataExtension(
           ...
           br.flieger.exacttarget.wsdl.api.DataExtensionField sendableDataExtensionField,
           br.flieger.exacttarget.wsdl.api.Attribute sendableSubscriberField,
           br.flieger.exacttarget.wsdl.api.DataExtensionTemplate template,
           ...
           br.flieger.exacttarget.wsdl.api.DataExtensionField[] fields,
           br.flieger.exacttarget.wsdl.api.DateTimeUnitOfMeasure dataRetentionPeriod,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.DataExtensionField getSendableDataExtensionField() {
        return sendableDataExtensionField;
    }
     ...
     */
    public void setSendableDataExtensionField(br.flieger.exacttarget.wsdl.api.DataExtensionField sendableDataExtensionField) {
        this.sendableDataExtensionField = sendableDataExtensionField;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.Attribute getSendableSubscriberField() {
        return sendableSubscriberField;
    }
     ...
     */
    public void setSendableSubscriberField(br.flieger.exacttarget.wsdl.api.Attribute sendableSubscriberField) {
        this.sendableSubscriberField = sendableSubscriberField;
    }
     ...
     * @return template
     */
    public br.flieger.exacttarget.wsdl.api.DataExtensionTemplate getTemplate() {
        return template;
    }
     ...
     * @param template
     */
    public void setTemplate(br.flieger.exacttarget.wsdl.api.DataExtensionTemplate template) {
        this.template = template;
    }
     ...
     * @return fields
     */
    public br.flieger.exacttarget.wsdl.api.DataExtensionField[] getFields() {
        return fields;
    }
     ...
     * @param fields
     */
    public void setFields(br.flieger.exacttarget.wsdl.api.DataExtensionField[] fields) {
        this.fields = fields;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.DateTimeUnitOfMeasure getDataRetentionPeriod() {
        return dataRetentionPeriod;
    }
     ...
     */
    public void setDataRetentionPeriod(br.flieger.exacttarget.wsdl.api.DateTimeUnitOfMeasure dataRetentionPeriod) {
        this.dataRetentionPeriod = dataRetentionPeriod;
    }
