...
public class DoubleOptInMOKeyword  extends br.flieger.exacttarget.wsdl.api.BaseMOKeyword  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.List defaultPublication;
    ...
    private br.flieger.exacttarget.wsdl.api.List[] validPublications;
    ...
    public DoubleOptInMOKeyword(
           ...
           br.flieger.exacttarget.wsdl.api.List defaultPublication,
           ...
           br.flieger.exacttarget.wsdl.api.List[] validPublications,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.List getDefaultPublication() {
        return defaultPublication;
    }
     ...
     */
    public void setDefaultPublication(br.flieger.exacttarget.wsdl.api.List defaultPublication) {
        this.defaultPublication = defaultPublication;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.List[] getValidPublications() {
        return validPublications;
    }
     ...
     */
    public void setValidPublications(br.flieger.exacttarget.wsdl.api.List[] validPublications) {
        this.validPublications = validPublications;
    }
