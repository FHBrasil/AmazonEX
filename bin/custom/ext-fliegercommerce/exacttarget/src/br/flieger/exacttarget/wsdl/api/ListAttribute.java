...
public class ListAttribute  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.ListAttributeFieldType fieldType;
    ...
    private br.flieger.exacttarget.wsdl.api.OverrideType overrideType;

    private java.lang.Integer ordinal;

    private br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue[] restrictedValues;

    private br.flieger.exacttarget.wsdl.api.ListAttribute baseAttribute;
    ...
    public ListAttribute(
           ...
           br.flieger.exacttarget.wsdl.api.ListAttributeFieldType fieldType,
           ...
           br.flieger.exacttarget.wsdl.api.OverrideType overrideType,
           java.lang.Integer ordinal,
           br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue[] restrictedValues,
           br.flieger.exacttarget.wsdl.api.ListAttribute baseAttribute) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     * @return fieldType
     */
    public br.flieger.exacttarget.wsdl.api.ListAttributeFieldType getFieldType() {
        return fieldType;
    }
     ...
     * @param fieldType
     */
    public void setFieldType(br.flieger.exacttarget.wsdl.api.ListAttributeFieldType fieldType) {
        this.fieldType = fieldType;
    }
     ...
     * @return overrideType
     */
    public br.flieger.exacttarget.wsdl.api.OverrideType getOverrideType() {
        return overrideType;
    }
     ...
     * @param overrideType
     */
    public void setOverrideType(br.flieger.exacttarget.wsdl.api.OverrideType overrideType) {
        this.overrideType = overrideType;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue[] getRestrictedValues() {
        return restrictedValues;
    }
     ...
     */
    public void setRestrictedValues(br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue[] restrictedValues) {
        this.restrictedValues = restrictedValues;
    }

    public br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue getRestrictedValues(int i) {
        return this.restrictedValues[i];
    }

    public void setRestrictedValues(int i, br.flieger.exacttarget.wsdl.api.ListAttributeRestrictedValue _value) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.ListAttribute getBaseAttribute() {
        return baseAttribute;
    }
     ...
     * @param baseAttribute
     */
    public void setBaseAttribute(br.flieger.exacttarget.wsdl.api.ListAttribute baseAttribute) {
        this.baseAttribute = baseAttribute;
    }
