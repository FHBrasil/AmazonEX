...
public class ResourceSpecification  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private java.lang.String URN;

    private br.flieger.exacttarget.wsdl.api.Authentication authentication;
    ...
    public ResourceSpecification(
           ...
           br.flieger.exacttarget.wsdl.api.Authentication authentication) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.Authentication getAuthentication() {
        return authentication;
    }
     ...
     */
    public void setAuthentication(br.flieger.exacttarget.wsdl.api.Authentication authentication) {
        this.authentication = authentication;
    }
