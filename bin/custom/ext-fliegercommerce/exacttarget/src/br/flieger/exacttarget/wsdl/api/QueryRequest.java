...
public class QueryRequest  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.Query query;
    ...
    public QueryRequest(
           ...
           br.flieger.exacttarget.wsdl.api.Query query,
     ...
     * @return query
     */
    public br.flieger.exacttarget.wsdl.api.Query getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(br.flieger.exacttarget.wsdl.api.Query query) {
        this.query = query;
    }
