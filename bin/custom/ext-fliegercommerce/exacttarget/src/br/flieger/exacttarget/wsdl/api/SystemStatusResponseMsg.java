...
public class SystemStatusResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.SystemStatusResult[] results;
    ...
    public SystemStatusResponseMsg(
           br.flieger.exacttarget.wsdl.api.SystemStatusResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.SystemStatusResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.SystemStatusResult[] results) {
        this.results = results;
    }
