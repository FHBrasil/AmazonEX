...
public class Owner  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.AccountUser user;
    ...
    public Owner(
           ...
           br.flieger.exacttarget.wsdl.api.AccountUser user) {
           this.client = client;
     ...
     * @return user
     */
    public br.flieger.exacttarget.wsdl.api.AccountUser getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(br.flieger.exacttarget.wsdl.api.AccountUser user) {
        this.user = user;
    }
