...
public class CreateResult  extends br.flieger.exacttarget.wsdl.api.Result  implements java.io.Serializable {
    private int newID;
    ...
    private br.flieger.exacttarget.wsdl.api.CreateResult[] createResults;
     ...
     */
    public br.flieger.exacttarget.wsdl.api.CreateResult[] getCreateResults() {
        return createResults;
    }
     ...
     * @param createResults
     */
    public void setCreateResults(br.flieger.exacttarget.wsdl.api.CreateResult[] createResults) {
        this.createResults = createResults;
    }

    public br.flieger.exacttarget.wsdl.api.CreateResult getCreateResults(int i) {
        return this.createResults[i];
    }

    public void setCreateResults(int i, br.flieger.exacttarget.wsdl.api.CreateResult _value) {
