...
public class Portfolio  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ResourceSpecification source;
    ...
    public Portfolio(
           ...
           br.flieger.exacttarget.wsdl.api.ResourceSpecification source,
     ...
     * @return source
     */
    public br.flieger.exacttarget.wsdl.api.ResourceSpecification getSource() {
        return source;
    }
     ...
     * @param source
     */
    public void setSource(br.flieger.exacttarget.wsdl.api.ResourceSpecification source) {
        this.source = source;
    }
