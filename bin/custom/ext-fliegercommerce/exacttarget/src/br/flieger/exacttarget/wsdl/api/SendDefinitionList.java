...
public class SendDefinitionList  extends br.flieger.exacttarget.wsdl.api.AudienceItem  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.FilterDefinition filterDefinition;
    ...
    public SendDefinitionList(
           ...
           br.flieger.exacttarget.wsdl.api.FilterDefinition filterDefinition,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.FilterDefinition getFilterDefinition() {
        return filterDefinition;
    }
     ...
     */
    public void setFilterDefinition(br.flieger.exacttarget.wsdl.api.FilterDefinition filterDefinition) {
        this.filterDefinition = filterDefinition;
    }
