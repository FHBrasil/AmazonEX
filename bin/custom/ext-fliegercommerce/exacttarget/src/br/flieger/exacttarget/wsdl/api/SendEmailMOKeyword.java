...
public class SendEmailMOKeyword  extends br.flieger.exacttarget.wsdl.api.BaseMOKeyword  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition triggeredSend;

    private br.flieger.exacttarget.wsdl.api.BaseMOKeyword nextMOKeyword;
    ...
    public SendEmailMOKeyword(
           ...
           br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition triggeredSend,
           br.flieger.exacttarget.wsdl.api.BaseMOKeyword nextMOKeyword) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition getTriggeredSend() {
        return triggeredSend;
    }
     ...
     * @param triggeredSend
     */
    public void setTriggeredSend(br.flieger.exacttarget.wsdl.api.TriggeredSendDefinition triggeredSend) {
        this.triggeredSend = triggeredSend;
    }
     ...
     */
    public br.flieger.exacttarget.wsdl.api.BaseMOKeyword getNextMOKeyword() {
        return nextMOKeyword;
    }
     ...
     * @param nextMOKeyword
     */
    public void setNextMOKeyword(br.flieger.exacttarget.wsdl.api.BaseMOKeyword nextMOKeyword) {
        this.nextMOKeyword = nextMOKeyword;
    }
