...
public class AutomationInstance  extends br.flieger.exacttarget.wsdl.api.Automation  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.AutomationTaskInstance[] taskInstances;
    ...
    public AutomationInstance(
           ...
           br.flieger.exacttarget.wsdl.api.AutomationTaskInstance[] taskInstances,
     ...
     */
    public br.flieger.exacttarget.wsdl.api.AutomationTaskInstance[] getTaskInstances() {
        return taskInstances;
    }
     ...
     * @param taskInstances
     */
    public void setTaskInstances(br.flieger.exacttarget.wsdl.api.AutomationTaskInstance[] taskInstances) {
        this.taskInstances = taskInstances;
    }
