...
public class VersionInfoResponse  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.VersionInfoResponse[] versionHistory;
    ...
    public VersionInfoResponse(
           ...
           br.flieger.exacttarget.wsdl.api.VersionInfoResponse[] versionHistory) {
     ...
     */
    public br.flieger.exacttarget.wsdl.api.VersionInfoResponse[] getVersionHistory() {
        return versionHistory;
    }
     ...
     */
    public void setVersionHistory(br.flieger.exacttarget.wsdl.api.VersionInfoResponse[] versionHistory) {
        this.versionHistory = versionHistory;
    }

    public br.flieger.exacttarget.wsdl.api.VersionInfoResponse getVersionHistory(int i) {
        return this.versionHistory[i];
    }

    public void setVersionHistory(int i, br.flieger.exacttarget.wsdl.api.VersionInfoResponse _value) {
