...
public class UpdateResponse  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.UpdateResult[] results;
    ...
    public UpdateResponse(
           br.flieger.exacttarget.wsdl.api.UpdateResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.UpdateResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.UpdateResult[] results) {
        this.results = results;
    }

    public br.flieger.exacttarget.wsdl.api.UpdateResult getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, br.flieger.exacttarget.wsdl.api.UpdateResult _value) {
