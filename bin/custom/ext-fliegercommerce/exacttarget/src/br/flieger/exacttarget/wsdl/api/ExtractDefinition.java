...
public class ExtractDefinition  extends br.flieger.exacttarget.wsdl.api.ExtractTemplate  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ExtractParameterDescription[] parameters;

    private br.flieger.exacttarget.wsdl.api.APIProperty[] values;
    ...
    public ExtractDefinition(
           ...
           br.flieger.exacttarget.wsdl.api.ExtractParameterDescription[] parameters,
           br.flieger.exacttarget.wsdl.api.APIProperty[] values) {
        super(
            client,
            partnerKey,
            partnerProperties,
     ...
     * @return parameters
     */
    public br.flieger.exacttarget.wsdl.api.ExtractParameterDescription[] getParameters() {
        return parameters;
    }
     ...
     * @param parameters
     */
    public void setParameters(br.flieger.exacttarget.wsdl.api.ExtractParameterDescription[] parameters) {
        this.parameters = parameters;
    }
     ...
     * @return values
     */
    public br.flieger.exacttarget.wsdl.api.APIProperty[] getValues() {
        return values;
    }
     ...
     * @param values
     */
    public void setValues(br.flieger.exacttarget.wsdl.api.APIProperty[] values) {
        this.values = values;
    }
