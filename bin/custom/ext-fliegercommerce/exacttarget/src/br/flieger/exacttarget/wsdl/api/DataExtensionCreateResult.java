/**
 * DataExtensionCreateResult.java
 *
...
public class DataExtensionCreateResult  extends br.flieger.exacttarget.wsdl.api.CreateResult  implements java.io.Serializable {
    private java.lang.String errorMessage;

    private br.flieger.exacttarget.wsdl.api.DataExtensionError[] keyErrors;

    private br.flieger.exacttarget.wsdl.api.DataExtensionError[] valueErrors;

    public DataExtensionCreateResult() {
    }
    ...
    public DataExtensionCreateResult(
           ...
           br.flieger.exacttarget.wsdl.api.DataExtensionError[] keyErrors,
           br.flieger.exacttarget.wsdl.api.DataExtensionError[] valueErrors) {
        super(
            statusCode,
            statusMessage,
            ordinalID,
    ...
    /**
     * Gets the errorMessage value for this DataExtensionCreateResult.
     * 
     * @return errorMessage
     */
    ...
    /**
     * Sets the errorMessage value for this DataExtensionCreateResult.
     * 
     * @param errorMessage
     */
    ...
    /**
     * Gets the keyErrors value for this DataExtensionCreateResult.
     * 
     * @return keyErrors
     */
    public br.flieger.exacttarget.wsdl.api.DataExtensionError[] getKeyErrors() {
        return keyErrors;
    }


    /**
     * Sets the keyErrors value for this DataExtensionCreateResult.
     * 
     * @param keyErrors
     */
    public void setKeyErrors(br.flieger.exacttarget.wsdl.api.DataExtensionError[] keyErrors) {
        this.keyErrors = keyErrors;
    }


    /**
     * Gets the valueErrors value for this DataExtensionCreateResult.
     * 
     * @return valueErrors
     */
    public br.flieger.exacttarget.wsdl.api.DataExtensionError[] getValueErrors() {
        return valueErrors;
    }


    /**
     * Sets the valueErrors value for this DataExtensionCreateResult.
     * 
     * @param valueErrors
     */
    public void setValueErrors(br.flieger.exacttarget.wsdl.api.DataExtensionError[] valueErrors) {
        this.valueErrors = valueErrors;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DataExtensionCreateResult)) return false;
        DataExtensionCreateResult other = (DataExtensionCreateResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DataExtensionCreateResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://exacttarget.com/wsdl/partnerAPI", "DataExtensionCreateResult"));
