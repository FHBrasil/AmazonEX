...
public class ConfigureResponseMsg  implements java.io.Serializable {
    private br.flieger.exacttarget.wsdl.api.ConfigureResult[] results;
    ...
    public ConfigureResponseMsg(
           br.flieger.exacttarget.wsdl.api.ConfigureResult[] results,
     ...
     * @return results
     */
    public br.flieger.exacttarget.wsdl.api.ConfigureResult[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(br.flieger.exacttarget.wsdl.api.ConfigureResult[] results) {
        this.results = results;
    }
