...
public class SuppressionListDefinition  extends br.flieger.exacttarget.wsdl.api.APIObject  implements java.io.Serializable {
    ...
    private br.flieger.exacttarget.wsdl.api.SuppressionListContext[] contexts;
    ...
    public SuppressionListDefinition(
           ...
           br.flieger.exacttarget.wsdl.api.SuppressionListContext[] contexts,
     ...
     * @return contexts
     */
    public br.flieger.exacttarget.wsdl.api.SuppressionListContext[] getContexts() {
        return contexts;
    }
     ...
     * @param contexts
     */
    public void setContexts(br.flieger.exacttarget.wsdl.api.SuppressionListContext[] contexts) {
        this.contexts = contexts;
    }
