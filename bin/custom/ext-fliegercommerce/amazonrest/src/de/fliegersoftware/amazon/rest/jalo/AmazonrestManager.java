 ...
 *  
 */
package de.fliegersoftware.amazon.rest.jalo;
...
import de.fliegersoftware.amazon.rest.constants.AmazonrestConstants;



/**
 * This is the extension manager of the Amazonrest extension.
 */
public class AmazonrestManager extends GeneratedAmazonrestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmazonrestManager.class.getName());
	 ...
	 */
	public static AmazonrestManager getInstance()
	{
		return (AmazonrestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonrestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonrestManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonrestManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonrestManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonrestManager called, current tenant: " + getTenant().getTenantID());
		}
	}
