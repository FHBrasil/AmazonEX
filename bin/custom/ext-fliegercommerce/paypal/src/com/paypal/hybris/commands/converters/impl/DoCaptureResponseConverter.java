...
public class DoCaptureResponseConverter extends
    ...
    public void populate(DoCaptureResponseType doCaptureResponse, CaptureResult captureResult) {
        ...
        PaymentStatus paymentStatus =
                PaymentStatus.valueOf(paymentInfo.getPaymentStatus().value().toUpperCase());
        if (PaypalConstants.STATUS_SUCCESS.equals(doCaptureResponse.getAck().value())) {
            ...
            captureResult.setTotalAmount(BigDecimal.valueOf(NumberUtils.toDouble(paymentInfo
        ...
        captureResult.setRequestTime(doCaptureResponse.getTimestamp().toGregorianCalendar()
                .getTime());
