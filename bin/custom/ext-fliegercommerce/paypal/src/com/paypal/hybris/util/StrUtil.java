...
public static final byte[] BOM = new byte[] { (byte) 0xEF, (byte) 0xBB,
		(byte) 0xBF }; // BOM for UTF-8
 ...
 */
public static String getPar(final Map<String, String[]> params,
...
public static String getPar(final Map<String, String[]> params,
	...
	return getPar(params, key, null, fToLower);
}
...
public static String getPar(final Map<String, String[]> params,
	...
	return getPar(params, key, defaultValue, false);
}


public static String getPar(final Map<String, String[]> params, final String key) {

	return getPar(params, key, false);
}


public static Map<String, String[]> paramsToLower(
...
public static String formatNumParam(final Map<String, String[]> params,
	...
	final String strValue = StrUtil.getPar(params, paramName);
	final double doubleValue = StrUtil.toDouble(strValue, defaultValue);
...
//		if (LOG.isDebugEnabled()) {
			LOG.info("Converting to BigDecimal: " + stringValue + ", result: "
					+ newBigValue);
//		}
	} catch (final Exception e) {
