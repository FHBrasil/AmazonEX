...
/**
 * Global class for all Paypal constants. You can add global constants for your extension into
 * this class.
 */
public final class PaypalConstants extends GeneratedPaypalConstants {
    ...
    public static final String SETT_REDIRECT_REPEAT_ORDER_URL_DESKTOP =
            "paypal.redirectUrl.repeat.order.desktop";
    public static final String SETT_REDIRECT_REPEAT_ORDER_URL_MOBILE =
            "paypal.redirectUrl.repeat.order.mobile";
