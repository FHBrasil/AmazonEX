 ...
 */
public class PayPalResponseConverter extends AbstractPopulatingConverter<AbstractResponseType, AbstractResultData> {
	 ...
	 */
	@Override
	public void populate(AbstractResponseType response, AbstractResultData resultData) {
