...
public interface PaypalPaymentService {
     ...
     */
    GetExpressCheckoutDetailsResponseType getExpressCheckoutDetails(
    ...
    DoExpressCheckoutPaymentResponseType doExpressCheckoutPayment(
            DoExpressCheckoutPaymentRequestType request);
    ...
    GetTransactionDetailsResponseType
            getTransactionDetails(GetTransactionDetailsRequestType request);
    ...
    DoReferenceTransactionResponseType doReferenceTransaction(
            DoReferenceTransactionRequestType request);
}
