...
/**
 * JUnit Tests for the Paypal extension
 */
public class PaypalTest extends HybrisJUnit4TransactionalTest {
...
private static final Logger LOG = Logger.getLogger(PaypalTest.class.getName());
