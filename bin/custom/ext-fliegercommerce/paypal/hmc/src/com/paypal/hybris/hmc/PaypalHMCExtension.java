...
/**
 * Provides necessary meta information about the paypal hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class PaypalHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PaypalHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.paypal.hybris.hmc.locales";
