 ...
 *  
 */
package com.flieger.recommendation.jalo;
...
import com.flieger.recommendation.constants.RecommendationConstants;



/**
 * This is the extension manager of the Recommendation extension.
 */
public class RecommendationManager extends GeneratedRecommendationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecommendationManager.class.getName());
	...
	{
		return (RecommendationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RecommendationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecommendationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecommendationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecommendationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecommendationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
