...
/**
 * This is the extension manager of the Amazoncore extension.
 */
public class AmazoncoreManager extends GeneratedAmazoncoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmazoncoreManager.class.getName());
	 ...
	 */
	public static AmazoncoreManager getInstance()
	{
		return (AmazoncoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazoncoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazoncoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazoncoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazoncoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazoncoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
