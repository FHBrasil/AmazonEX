...
import com.flieger.payment.constants.MundipaggConstants;



/**
 * This is the extension manager of the Mundipagg extension.
 */
public class MundipaggManager extends GeneratedMundipaggManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MundipaggManager.class.getName());
	 ...
	 */
	public static MundipaggManager getInstance()
	{
		return (MundipaggManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MundipaggConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MundipaggManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MundipaggManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MundipaggManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MundipaggManager called, current tenant: " + getTenant().getTenantID());
		}
	}
