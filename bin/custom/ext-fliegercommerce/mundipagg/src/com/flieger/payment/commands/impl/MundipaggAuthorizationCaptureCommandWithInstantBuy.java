 ...
 * @author Antony
 */
public class MundipaggAuthorizationCaptureCommandWithInstantBuy extends MundipaggGenericCommand implements AuthorizationCaptureCommandWithInstantBuy
{
...
//		createOrderRequest.setAmountInCents(amountInCents);
		...
		creditCardTransaction.setInstantBuyKey(request.getMundipaggInstantBuyKey());	
