...
objectExtend(HtmlRunnerTestLoop.prototype, {
    ...
    commandComplete : function(result) {
        ...
        if (result.failed) {
			...
			if (globalStoredVars["GE_LASTERROR"] != "")
				globalStoredVars["GE_LASTERROR"] = globalStoredVars["GE_LASTERROR"] + ", " + currentTest.currentCommand.command + "(" +currentTest.currentCommand.target+","+currentTest.currentCommand.value + ") > " + result.failureMessage;
			else
				globalStoredVars["GE_LASTERROR"] = currentTest.currentCommand.command + "(" +currentTest.currentCommand.target+","+currentTest.currentCommand.value + ") > " + result.failureMessage;
    ...
    commandError : function(errorMessage) {
		...
		if (globalStoredVars["GE_LASTERROR"] != "")
			globalStoredVars["GE_LASTERROR"] = globalStoredVars["GE_LASTERROR"] + ", " + currentTest.currentCommand.command + "(" +currentTest.currentCommand.target+","+currentTest.currentCommand.value + ") > " + errorMessage;
		else
			globalStoredVars["GE_LASTERROR"] = currentTest.currentCommand.command + "(" +currentTest.currentCommand.target+","+currentTest.currentCommand.value + ") > " + errorMessage;
    },
