...
import de.fliegersoftware.amazon.hmc.constants.AmazonhmcConstants;



/**
 * This is the extension manager of the Amazonhmc extension.
 */
public class AmazonhmcManager extends GeneratedAmazonhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmazonhmcManager.class.getName());
	 ...
	 */
	public static AmazonhmcManager getInstance()
	{
		return (AmazonhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
