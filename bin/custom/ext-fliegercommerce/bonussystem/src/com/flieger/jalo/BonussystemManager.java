...
/**
 * This is the extension manager of the Bonussystem extension.
 */
public class BonussystemManager extends GeneratedBonussystemManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BonussystemManager.class.getName());
	 ...
	 */
	public static BonussystemManager getInstance()
	{
		return (BonussystemManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BonussystemConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonussystemManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BonussystemManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BonussystemManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BonussystemManager called, current tenant: " + getTenant().getTenantID());
		}
	}
