...
<%-- <c:if test="${fn:length(bonusSystem) > 0}"> --%>
...
<!-- 				</thead> -->
<!-- 				<tbody> -->
<%-- 					<c:forEach items="${bonusSystem}" var="entry" begin="0" end="9"> --%>
<!-- 						<tr> -->
<!-- 							<td> -->
<%-- 								${entry.points > 0 ? "+" : ""}  --%>
...
<%-- 					<c:set var="endList" value="${fn:length(bonusSystem)}" /> --%>
<%-- 					<c:forEach items="${bonusSystem}" var="entry" begin="10" end="${endList}"> --%>
<!-- 						<tr> -->
<!-- 							<td> -->
<%-- 								${entry.points > 0 ? "+" : ""}  --%>
<%-- 								<fmt:formatNumber maxFractionDigits="0" value="${entry.points}"/> --%>
