...
import com.flieger.bonussystem.constants.BonussystemaddonConstants;



/**
 * This is the extension manager of the Bonussystemaddon extension.
 */
public class BonussystemaddonManager extends GeneratedBonussystemaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BonussystemaddonManager.class.getName());
	 ...
	 */
	public static BonussystemaddonManager getInstance()
	{
		return (BonussystemaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BonussystemaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonussystemaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BonussystemaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BonussystemaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BonussystemaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
