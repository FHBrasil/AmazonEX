...
import com.flieger.constants.CorreiosConstants;



/**
 * This is the extension manager of the Correios extension.
 */
public class CorreiosManager extends GeneratedCorreiosManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CorreiosManager.class.getName());
	 ...
	 */
	public static CorreiosManager getInstance()
	{
		return (CorreiosManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CorreiosConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CorreiosManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CorreiosManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CorreiosManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CorreiosManager called, current tenant: " + getTenant().getTenantID());
		}
	}
