 ...
 *  
 */
package com.flieger.commerce.cms.jalo;
...
import com.flieger.commerce.cms.constants.FliegercommercecmsConstants;



/**
 * This is the extension manager of the Fliegercommercecms extension.
 */
public class FliegercommercecmsManager extends GeneratedFliegercommercecmsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FliegercommercecmsManager.class.getName());
	 ...
	 */
	public static FliegercommercecmsManager getInstance()
	{
		return (FliegercommercecmsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FliegercommercecmsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FliegercommercecmsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FliegercommercecmsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FliegercommercecmsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FliegercommercecmsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
