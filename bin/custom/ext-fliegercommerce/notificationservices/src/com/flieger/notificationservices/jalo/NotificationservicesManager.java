 ...
 *  
 */
package com.flieger.notificationservices.jalo;
...
/**
 * This is the extension manager of the Notificationservices extension.
 */
public class NotificationservicesManager extends GeneratedNotificationservicesManager
{
	 ...
	 */
	public static NotificationservicesManager getInstance()
	{
		return (NotificationservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NotificationservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NotificationservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NotificationservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NotificationservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NotificationservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
