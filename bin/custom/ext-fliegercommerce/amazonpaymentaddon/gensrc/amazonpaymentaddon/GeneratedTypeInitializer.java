...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"AmazonAddressBookComponent",
			"CMSParagraphComponent",
			de.fliegersoftware.amazon.payment.addon.jalo.AmazonAddressBookComponent.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"AmazonPayButtonComponent",
			"CMSParagraphComponent",
			de.fliegersoftware.amazon.payment.addon.jalo.AmazonPayButtonComponent.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"AmazonWalletComponent",
			"CMSParagraphComponent",
			de.fliegersoftware.amazon.payment.addon.jalo.AmazonWalletComponent.class,
			null,
			false,
			null,
			false
