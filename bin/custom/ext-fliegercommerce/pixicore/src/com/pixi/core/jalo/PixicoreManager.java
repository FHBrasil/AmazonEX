...
import com.pixi.core.constants.PixicoreConstants;



/**
 * This is the extension manager of the Pixicore extension.
 */
public class PixicoreManager extends GeneratedPixicoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PixicoreManager.class.getName());
	 ...
	 */
	public static PixicoreManager getInstance()
	{
		return (PixicoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PixicoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PixicoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PixicoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PixicoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PixicoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
