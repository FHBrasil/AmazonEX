 ...
 *  
 */
package com.flieger.bonussystem.jalo;
...
import com.flieger.bonussystem.constants.BonussystemfacadesConstants;



/**
 * This is the extension manager of the Bonussystemfacades extension.
 */
public class BonussystemfacadesManager extends GeneratedBonussystemfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BonussystemfacadesManager.class.getName());
	 ...
	 */
	public static BonussystemfacadesManager getInstance()
	{
		return (BonussystemfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BonussystemfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonussystemfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BonussystemfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BonussystemfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BonussystemfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
