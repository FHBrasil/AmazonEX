 ...
 *  
 */
package de.fliegersoftware.amazon.login.addon.hmc;
...
/**
 * Provides necessary meta information about the amazonloginaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class AmazonloginaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AmazonloginaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.fliegersoftware.amazon.login.addon.hmc.locales";
