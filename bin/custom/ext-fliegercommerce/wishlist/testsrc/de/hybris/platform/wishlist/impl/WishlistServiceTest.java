...
{
	private static final String WLDEFAULT = "Aniversário";
	...
	public void testWishlistService()
	{
		...
		{
			wishlistService.createDefaultWishlist(WLDEFAULT, "Eu desejo...");
		}
	...
	{
		final Wishlist2Model wishlist = wishlistService.createDefaultWishlist(WLDEFAULT, "Minha lista de Desejos");
		wishlistService.addWishlistEntry(product1, Integer.valueOf(1), Wishlist2EntryPriority.MEDIUM, "Média");
		return wishlist;
	}
