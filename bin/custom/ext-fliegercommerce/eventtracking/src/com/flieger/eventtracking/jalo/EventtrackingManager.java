 ...
 *  
 */
package com.flieger.eventtracking.jalo;
...
import com.flieger.eventtracking.constants.EventtrackingConstants;



/**
 * This is the extension manager of the Eventtracking extension.
 */
public class EventtrackingManager extends GeneratedEventtrackingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EventtrackingManager.class.getName());
	...
	{
		return (EventtrackingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EventtrackingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EventtrackingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EventtrackingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EventtrackingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EventtrackingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
