 ...
 * discounts on cart, one relative percentage discount and one absolute discount. Adds a third cart entry with a
 * different taxValue to the cart to determine how taxValues for global discounts will be calculated.<br>
 * 
 * <br>
...
@Ignore
public class GrossCartWithGlobalDiscountAndDiffTaxValuesTest extends AbstractReserveAmountTest {

	private static final Logger LOG = Logger.getLogger(GrossCartWithGlobalDiscountAndDiffTaxValuesTest.class);
	...
	public CartModel createCart(final ReserveAmountParams pReserveAmountParams) throws CalculationException {
		...
		addProductsCart(pReserveAmountParams,
			...
			true, true); // yes, add new entry for product with a different taxValue
