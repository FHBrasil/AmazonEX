...
/**
 * Creates and runs test for standard gross calculated cart objects with two cart entries and with a percentage discount
 * and an absolute discount to every cart entry. <br>
 * 
 * <br>
...
@Ignore
public class GrossCartWithTwoDifferentEntryDiscountsTest extends AbstractReserveAmountTest {

	private static final Logger LOG = Logger.getLogger(GrossCartWithTwoDifferentEntryDiscountsTest.class);
	...
	public CartModel createCart(final ReserveAmountParams pReserveAmountParams) throws CalculationException {
		...
		// add one percentage and one absolute discount to a cart entry
