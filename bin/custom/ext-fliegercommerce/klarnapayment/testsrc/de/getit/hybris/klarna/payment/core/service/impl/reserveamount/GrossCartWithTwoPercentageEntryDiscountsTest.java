...
/**
 * Creates and runs test for standard gross calculated cart objects with two standard cart entries and with two
 * percentage discounts to every cart entry. <br>
 * 
 * <br>
...
@Ignore
public class GrossCartWithTwoPercentageEntryDiscountsTest extends AbstractReserveAmountTest {

	private static final Logger LOG = Logger.getLogger(GrossCartWithTwoPercentageEntryDiscountsTest.class);
	...
	public CartModel createCart(final ReserveAmountParams pReserveAmountParams) throws CalculationException {
		...
		// add two percentage discounts to a cart entry
		addProductsCart(pReserveAmountParams,//
			...
			false, false); // no new entry for product with different taxValue
