 ...
 */
public class MediaContainerMultiThreadedImportProcessor extends MultiThreadedImportProcessor
{
	/**
	 * Logger
	 */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MediaContainerMultiThreadedImportProcessor.class);
