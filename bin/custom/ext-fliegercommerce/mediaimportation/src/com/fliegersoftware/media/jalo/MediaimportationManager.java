 ...
 *
 */
package com.fliegersoftware.media.jalo;
...
import com.fliegersoftware.media.constants.MediaimportationConstants;



/**
 * This is the extension manager of the Mediaimportation extension.
 */
public class MediaimportationManager extends GeneratedMediaimportationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MediaimportationManager.class.getName());
	 ...
	 */
	public static MediaimportationManager getInstance()
	{
		return (MediaimportationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MediaimportationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MediaimportationManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MediaimportationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MediaimportationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MediaimportationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
