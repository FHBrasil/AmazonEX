 ...
 *  
 */
package de.fliegersoftware.jalo;
...
import de.fliegersoftware.constants.LoggingConstants;



/**
 * This is the extension manager of the Logging extension.
 */
public class LoggingManager extends GeneratedLoggingManager
{
	...
	{
		return (LoggingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LoggingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LoggingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LoggingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LoggingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LoggingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
