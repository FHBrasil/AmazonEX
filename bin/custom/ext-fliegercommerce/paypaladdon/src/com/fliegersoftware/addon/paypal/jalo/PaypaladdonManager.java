 ...
 *  
 */
package com.fliegersoftware.addon.paypal.jalo;
...
/**
 * This is the extension manager of the Paypaladdon extension.
 */
public class PaypaladdonManager extends GeneratedPaypaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PaypaladdonManager.class.getName());
	 ...
	 */
	public static PaypaladdonManager getInstance()
	{
		return (PaypaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PaypaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaypaladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PaypaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PaypaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PaypaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
