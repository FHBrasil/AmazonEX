package com.fliegersoftware.addon.paypal.facades.order.converters.populator;
...
public class PayPalOrderPopulator extends OrderPopulator {
    ...
    protected void addPaymentInformation(final AbstractOrderModel source,
        ...
        if (paymentInfo instanceof CreditCardPaymentInfoModel) {
            ...
            final CCPaymentInfoData paymentInfoData =
                    getPaypalPaymentInfoConverter().convert((PaypalPaymentInfoModel) paymentInfo);
            prototype.setPaymentInfo(paymentInfoData);
        }
    }
