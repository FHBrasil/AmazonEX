 ...
 *  
 */
package com.fliegersoftware.addon.paypal.hmc;
...
/**
 * Provides necessary meta information about the paypaladdon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class PaypaladdonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PaypaladdonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.fliegersoftware.addon.paypal.hmc.locales";
