...
public class RefundResponse  implements java.io.Serializable {
    private com.adyen.services.payment.ModificationResult refundResult;

    public RefundResponse() {
    }

    public RefundResponse(
           com.adyen.services.payment.ModificationResult refundResult) {
     ...
     * @return refundResult
     */
    public com.adyen.services.payment.ModificationResult getRefundResult() {
        return refundResult;
    }
     ...
     * @param refundResult
     */
    public void setRefundResult(com.adyen.services.payment.ModificationResult refundResult) {
        this.refundResult = refundResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://payment.services.adyen.com", ">refundResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("refundResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://payment.services.adyen.com", "refundResult"));
