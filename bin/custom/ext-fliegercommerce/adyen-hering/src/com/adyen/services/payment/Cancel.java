...
public class Cancel  implements java.io.Serializable {
    ...
    /**
     * Gets the modificationRequest value for this Cancel.
     * 
    ...
    /**
     * Sets the modificationRequest value for this Cancel.
     * 
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Cancel.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://payment.services.adyen.com", ">cancel"));
