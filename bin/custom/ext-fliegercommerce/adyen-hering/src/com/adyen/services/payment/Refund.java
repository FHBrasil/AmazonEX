...
public class Refund  implements java.io.Serializable {
    ...
    /**
     * Gets the modificationRequest value for this Refund.
     * 
    ...
    /**
     * Sets the modificationRequest value for this Refund.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://payment.services.adyen.com", ">refund"));
