...
/**
 * This is the extension manager of the Adyen extension.
 */
public class AdyenManager extends GeneratedAdyenManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyenManager.class.getName());
	 ...
	 */
	public static AdyenManager getInstance()
	{
		return (AdyenManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyenConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyenManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyenManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyenManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyenManager called, current tenant: " + getTenant().getTenantID());
		}
	}
