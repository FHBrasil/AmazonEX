 ...
 * 
 */
package com.hybris.metainformation.jalo;
...
import com.hybris.metainformation.constants.MetainformationConstants;



/**
 * This is the extension manager of the Metainformation extension.
 */
public class MetainformationManager extends GeneratedMetainformationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MetainformationManager.class.getName());
	...
	{
		return (MetainformationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MetainformationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MetainformationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MetainformationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MetainformationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MetainformationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
