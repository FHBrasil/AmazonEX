		...
		<main class="product-details">
			<div class="inner row">
				...
				<div class="product-info col-sm-6 col-md-6">
					<div class="product-info-heading row">
					...
					<cms:pageSlot position="ProductDetailsPanelSection" var="comp" element="div" class="row section-product-details">
						<cms:component component="${comp}"  />
					</cms:pageSlot>
					
					<cms:pageSlot position="ProductOrderSection" var="comp" element="div" class="row section-product-order">
						<cms:component component="${comp}"  />
					</cms:pageSlot>
										
					<cms:pageSlot position="SocialSection" var="comp" element="div" class="row section-product-social">
						<cms:component component="${comp}"  />
					</cms:pageSlot>
				</div>
			</div>
