...
/**
 * This is the extension manager of the Productpagepack extension.
 */
public class ProductpagepackManager extends GeneratedProductpagepackManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductpagepackManager.class.getName());
	 ...
	 */
	public static ProductpagepackManager getInstance()
	{
		return (ProductpagepackManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductpagepackConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductpagepackManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductpagepackManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductpagepackManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductpagepackManager called, current tenant: " + getTenant().getTenantID());
		}
	}
