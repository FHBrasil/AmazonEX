 ...
 * 
 */
package com.hybris.addon.common.setup.populators;
...
import com.hybris.addon.impex.ImpexMacroParameterData;

import de.hybris.platform.acceleratorservices.config.SiteConfigService;
import de.hybris.platform.acceleratorservices.enums.UiExperienceLevel;
import de.hybris.platform.acceleratorservices.uiexperience.UiExperienceService;
import de.hybris.platform.addonsupport.setup.AddOnDataImportEventContext;
 ...
 * 
 */
public class SupportedUiExperienceImpexMacroParameterPopulator implements Populator<AddOnDataImportEventContext, ImpexMacroParameterData>
{
	...
	{
		final String[] levelsAsString = StringUtils.split( getSiteConfigService().getProperty("storefront.supportedUiExperienceLevels"),",");
