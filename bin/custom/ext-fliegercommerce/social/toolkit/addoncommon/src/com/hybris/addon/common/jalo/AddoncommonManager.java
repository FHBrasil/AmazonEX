...
/**
 * This is the extension manager of the Addonsupport extension.
 */
public class AddoncommonManager extends GeneratedAddoncommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AddoncommonManager.class.getName());
	 ...
	 */
	public static AddoncommonManager getInstance()
	{
		return (AddoncommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AddoncommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AddoncommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AddonsupportManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AddonsupportManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AddonsupportManager called, current tenant: " + getTenant().getTenantID());
		}
	}
