...
public class GenericAddOnSampleDataEventListener extends AbstractEventListener<SampleDataImportedEvent>{
	...
	protected void onEvent(SampleDataImportedEvent event) {
		getAddOnSampleDataImportService().importSampleData(getExtensionName(), event.getContext(), event.getImportData(), isSolrReindex());
	}
	...
	@Required
	public void setAddOnSampleDataImportService(
			AddOnSampleDataImportService addOnSampleDataImportService) {
