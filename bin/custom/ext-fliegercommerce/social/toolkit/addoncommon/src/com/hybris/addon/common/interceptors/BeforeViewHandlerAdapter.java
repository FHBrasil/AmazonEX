...
public class BeforeViewHandlerAdapter implements FactoryBean<Object>, InitializingBean {
	...
	public Object getObject() throws Exception {
		...
		final ProxyFactory factory = new ProxyFactory(proxyObjectType, new org.aopalliance.intercept.MethodInterceptor() {
			...
			
			{
				...
				final Object result  = getAdaptee().beforeView((HttpServletRequest)arg0.getArguments()[0], (HttpServletResponse)arg0.getArguments()[1], modelMap, view);
	...
	protected void init() throws ClassNotFoundException
	{
		...
		final Class<?> modelParameterClazz = ClassUtils.resolveClassName("org.springframework.web.servlet.ModelAndView", ClassUtils.getDefaultClassLoader());
