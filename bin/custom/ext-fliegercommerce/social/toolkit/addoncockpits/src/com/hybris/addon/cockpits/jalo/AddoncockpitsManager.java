 ...
 * 
 */
package com.hybris.addon.cockpits.jalo;
...
import com.hybris.addon.cockpits.constants.AddoncockpitsConstants;



/**
 * This is the extension manager of the Addoncockpits extension.
 */
public class AddoncockpitsManager extends GeneratedAddoncockpitsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AddoncockpitsManager.class.getName());
	 ...
	 */
	public static AddoncockpitsManager getInstance()
	{
		return (AddoncockpitsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AddoncockpitsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AddoncockpitsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AddoncockpitsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AddoncockpitsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AddoncockpitsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
