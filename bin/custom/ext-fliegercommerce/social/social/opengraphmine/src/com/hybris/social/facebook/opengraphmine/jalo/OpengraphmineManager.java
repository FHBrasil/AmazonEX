 ...
 * 
 */
package com.hybris.social.facebook.opengraphmine.jalo;
...
/**
 * This is the extension manager of the Opengraphmine extension.
 */
public class OpengraphmineManager extends GeneratedOpengraphmineManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OpengraphmineManager.class.getName());
	 ...
	 */
	public static OpengraphmineManager getInstance()
	{
		return (OpengraphmineManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OpengraphmineConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OpengraphmineManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OpengraphmineManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OpengraphmineManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OpengraphmineManager called, current tenant: " + getTenant().getTenantID());
		}
	}
