 ...
 * 
 */
package com.hybris.social.googleplus.jalo;
...
import com.hybris.social.googleplus.constants.GoogleplusConstants;



/**
 * This is the extension manager of the Googleplus extension.
 */
public class GoogleplusManager extends GeneratedGoogleplusManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GoogleplusManager.class.getName());
	...
	{
		return (GoogleplusManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GoogleplusConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GoogleplusManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GoogleplusManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GoogleplusManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GoogleplusManager called, current tenant: " + getTenant().getTenantID());
		}
	}
