 ...
 * 
 */
package com.hybris.social.urlshortening.jalo;
...
import com.hybris.social.urlshortening.constants.UrlshorteningConstants;



/**
 * This is the extension manager of the Urlshortening extension.
 */
public class UrlshorteningManager extends GeneratedUrlshorteningManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UrlshorteningManager.class.getName());
	 ...
	 */
	public static UrlshorteningManager getInstance()
	{
		return (UrlshorteningManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				UrlshorteningConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UrlshorteningManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UrlshorteningManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of UrlshorteningManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of UrlshorteningManager called, current tenant: " + getTenant().getTenantID());
		}
	}
