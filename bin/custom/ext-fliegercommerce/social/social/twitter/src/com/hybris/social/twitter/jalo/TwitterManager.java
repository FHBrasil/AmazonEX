 ...
 * 
 */
package com.hybris.social.twitter.jalo;
...
import com.hybris.social.twitter.constants.TwitterConstants;



/**
 * This is the extension manager of the Twitter extension.
 */
public class TwitterManager extends GeneratedTwitterManager
{
	...
	{
		return (TwitterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TwitterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TwitterManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TwitterManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TwitterManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TwitterManager called, current tenant: " + getTenant().getTenantID());
		}
	}
