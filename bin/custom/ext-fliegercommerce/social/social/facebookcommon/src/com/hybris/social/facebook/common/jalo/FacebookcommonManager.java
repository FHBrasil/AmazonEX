 ...
 * 
 */
package com.hybris.social.facebook.common.jalo;
...
import com.hybris.social.facebook.common.constants.FacebookcommonConstants;



/**
 * This is the extension manager of the Facebookcommon extension.
 */
public class FacebookcommonManager extends GeneratedFacebookcommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebookcommonManager.class.getName());
	 ...
	 */
	public static FacebookcommonManager getInstance()
	{
		return (FacebookcommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebookcommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookcommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebookcommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebookcommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebookcommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
