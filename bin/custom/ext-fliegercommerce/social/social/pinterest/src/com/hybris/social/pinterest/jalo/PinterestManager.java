 ...
 * 
 */
package com.hybris.social.pinterest.jalo;
...
import com.hybris.social.pinterest.constants.PinterestConstants;



/**
 * This is the extension manager of the Pinterest extension.
 */
public class PinterestManager extends GeneratedPinterestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PinterestManager.class.getName());
	 ...
	 */
	public static PinterestManager getInstance()
	{
		return (PinterestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PinterestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PinterestManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PinterestManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PinterestManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PinterestManager called, current tenant: " + getTenant().getTenantID());
		}
	}
