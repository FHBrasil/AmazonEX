 ...
 * 
 */
package com.hybris.social.facebook.socialplugins.jalo;
...
import com.hybris.social.facebook.socialplugins.constants.FacebooksocialpluginsConstants;



/**
 * This is the extension manager of the Facebooksocialplugins extension.
 */
public class FacebooksocialpluginsManager extends GeneratedFacebooksocialpluginsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebooksocialpluginsManager.class.getName());
	 ...
	 */
	public static FacebooksocialpluginsManager getInstance()
	{
		return (FacebooksocialpluginsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebooksocialpluginsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebooksocialpluginsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebooksocialpluginsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebooksocialpluginsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebooksocialpluginsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
