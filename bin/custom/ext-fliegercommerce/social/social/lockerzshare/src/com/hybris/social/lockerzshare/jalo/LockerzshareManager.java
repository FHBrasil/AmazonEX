 ...
 * 
 */
package com.hybris.social.lockerzshare.jalo;
...
import com.hybris.social.lockerzshare.constants.LockerzshareConstants;



/**
 * This is the extension manager of the Lockerzshare extension.
 */
public class LockerzshareManager extends GeneratedLockerzshareManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LockerzshareManager.class.getName());
	 ...
	 */
	public static LockerzshareManager getInstance()
	{
		return (LockerzshareManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LockerzshareConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LockerzshareManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LockerzshareManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LockerzshareManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LockerzshareManager called, current tenant: " + getTenant().getTenantID());
		}
	}
