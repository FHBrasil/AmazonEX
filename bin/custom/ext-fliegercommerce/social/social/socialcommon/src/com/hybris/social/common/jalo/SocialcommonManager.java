 ...
 * 
 */
package com.hybris.social.common.jalo;
...
/**
 * This is the extension manager of the Socialcommon extension.
 */
public class SocialcommonManager extends GeneratedSocialcommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SocialcommonManager.class.getName());
	 ...
	 */
	public static SocialcommonManager getInstance()
	{
		return (SocialcommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SocialcommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SocialcommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SocialcommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SocialcommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SocialcommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
