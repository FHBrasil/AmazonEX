...
/**
 * This is the extension manager of the Amazonhmcaddon extension.
 */
public class AmazonhmcaddonManager extends GeneratedAmazonhmcaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmazonhmcaddonManager.class.getName());
	 ...
	 */
	public static AmazonhmcaddonManager getInstance()
	{
		return (AmazonhmcaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonhmcaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonhmcaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonhmcaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonhmcaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonhmcaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
