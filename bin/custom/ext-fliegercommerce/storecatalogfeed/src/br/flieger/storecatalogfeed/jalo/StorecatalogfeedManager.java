...
public class StorecatalogfeedManager extends GeneratedStorecatalogfeedManager
{
	...
	{
		return (StorecatalogfeedManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StorecatalogfeedConstants.EXTENSIONNAME);
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StorecatalogfeedManager called, current tenant: " + getTenant().getTenantID());
		}
	}
