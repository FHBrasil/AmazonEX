...
public abstract class AbstractFeedThread extends Thread
{
	...
	protected XMLTemplate<ProductModel> createTemplate(final String templateBeanName)
	{
		...
		final XMLTemplate<ProductModel> templateBean = appCtx.getBean(templateBeanName + "Template", XMLTemplate.class);
	...
	/**
	 * @param storeFeedDao the storeFeedDao to set
	 */
	...
	/**
	 * @param catalogVersion the catalogVersion to set
	 */
	...
	/**
	 * @param xmlTemplate the xmlTemplate to set
	 */
