...
public final class DefaultStoreFeedDao extends AbstractItemDao
{
	...
	public Set<ProductModel> findByPaging(CatalogVersionModel catalogVersion, String xmlTemplate, int beginindex, int total) {
		String query = null;
	...
	private String getBaseProductsQuery(boolean order) 
	{
		...
		.append(" FROM {HeringProduct AS p} ")
	...
	/* (non-Javadoc)
	 * @see de.fliegersoftware.catalog.dao.CatalogDAO#paginatedSearch(java.lang.Class, java.lang.String, java.util.Map, int, int)
	 */
	private Set<ProductModel> paginatedSearch(CatalogVersionModel catalogVersion, String query, int beginindex, int total) 
	{
	 ...
	 * @return
	 */
	private FlexibleSearchQuery getDefaultSearchQuery(CatalogVersionModel catalogVersion, String query)
	{
