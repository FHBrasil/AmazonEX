 ...
 *
 */
public class BaseProductsFromCatalogTemplate 
		extends AllProductsFromCatalogTemplate {
	...
	public Document apply(Set<ProductModel> products) {
		...
		for (final ProductModel product : products) {
			try {
				...
				Integer installment = firstVariantPrice == null ? new Integer(0)
				: new Integer(calculateAvailableInstallments(
						firstVariantPrice.doubleValue()));
				...
				for(HeringStyleVariantProductModel style: styles) {
					for(VariantProductModel size: style.getVariants()) {
						...
						BigDecimal variantPrice = getPrice(sizeVariant
								.getEurope1Prices());
   					...
   					variantElement.addContent(xmlUtils.createElement("color",
