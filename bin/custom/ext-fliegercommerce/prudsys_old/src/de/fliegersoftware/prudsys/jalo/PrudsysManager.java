 ...
 *  
 */
package de.fliegersoftware.prudsys.jalo;
...
import de.fliegersoftware.prudsys.constants.PrudsysConstants;



/**
 * This is the extension manager of the Prudsys extension.
 */
public class PrudsysManager extends GeneratedPrudsysManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PrudsysManager.class.getName());
	 ...
	 */
	public static PrudsysManager getInstance()
	{
		return (PrudsysManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PrudsysConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PrudsysManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PrudsysManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PrudsysManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PrudsysManager called, current tenant: " + getTenant().getTenantID());
		}
	}
