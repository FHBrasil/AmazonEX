 ...
 *  
 */
package de.fliegersoftware.prudsys.hmc;
...
/**
 * Provides necessary meta information about the prudsys hmc extension.
 * 
 * 
 * @version ExtGen v4
 */
public class PrudsysHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PrudsysHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.fliegersoftware.prudsys.hmc.locales";
