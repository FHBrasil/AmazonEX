...
public class ConfirmOrderController extends AbstractPixiSecuredController
{
	...
	public @ResponseBody ImportOrderStatusResponse handle(@RequestParam(value = "order_id") final String orderId, @RequestParam final String session)
	{
		...
		final OrderModel order = getCustomerAccountService().getOrderDetailsForGUID(orderId, store);//XXX estamos usando getOrderDetailsForGUID para compilar na 5.1.1.7, precisa validar se funciona
