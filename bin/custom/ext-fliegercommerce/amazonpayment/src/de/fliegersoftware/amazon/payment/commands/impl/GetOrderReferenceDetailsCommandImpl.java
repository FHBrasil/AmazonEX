...
private final static Logger LOG = Logger.getLogger(GetOrderReferenceDetailsCommandImpl.class);
...
public GetOrderReferenceDetailsResult perform(final GetOrderReferenceDetailsRequest req) {
	...
	try {
   	...
   	GetOrderReferenceDetailsResponse orderReferenceDetail = offAmazonPaymentsService.getOrderReferenceDetails(req);
