...
/**
 * This is the extension manager of the Amazonpayment extension.
 */
public class AmazonpaymentManager extends GeneratedAmazonpaymentManager
{
	 ...
	 */
	public static AmazonpaymentManager getInstance()
	{
		return (AmazonpaymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonpaymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonpaymentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonpaymentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonpaymentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonpaymentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
