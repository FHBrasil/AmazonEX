				...
				<c:forEach items="${cartData.entries}" var="entry">
					...
					<tr>
						...
						<td headers="header3" class="quantity">
							...
							<form:form id="updateCartForm${entry.entryNumber}" action="${cartUpdateFormAction}" method="post" commandName="updateQuantityForm${entry.product.code}">
								...
								<ycommerce:testId code="cart_product_quantity">
									...
									<form:input disabled="${not entry.updateable}" type="text" size="1" id="quantity${entry.entryNumber}" class="qty" value="${entry.quantity}" path="quantity"/>
								</ycommerce:testId>
