	...
	<div class="prod">
		...
		<div class="prod_review">
			...
			<p class="prod_review-new">
				<a href="#" id="write_review_action_main"><spring:theme code="review.write.title" arguments="${product.name}" /></a>
			</p>
		</div>
		...
		<c:if test="${not empty variantStyles or not empty variantSizes}">
			<c:choose>
				<c:when test="${product.purchasable and product.stockLevelStatus.code ne 'outOfStock' }">
					<c:set var="showAddToCart" value="${true}" />
				</c:when>
				<c:otherwise>
		...
		<product:klarnaMonthlyCostsPanel klarnaMonthlyCosts="${klarnaMonthlyCosts}"/>
		

		<%-- AddThis Button BEGIN --%>
		<script type="text/javascript">
			var addthis_config = {
      			ui_language: "${currentLanguage.isocode}" 
		} 
			
		</script>
		<div class="addthis_toolbox addthis_default_style addthis_32x32_style">
        	<a class="addthis_button_preferred_1" 
        		alt="<spring:theme code="product.share.tweet"/>"
				title="<spring:theme code="product.share.tweet"/>">
			</a>
       		<a class="addthis_button_preferred_2"
       			alt="<spring:theme code="product.share.print"/>"
				title="<spring:theme code="product.share.print"/>">
			</a>
        	<a class="addthis_button_preferred_3"
        		alt="<spring:theme code="product.share.sendToFacebook"/>"
				title="<spring:theme code="product.share.sendToFacebook"/>">
			</a>
        	<a class="addthis_button_preferred_4"
        		alt="<spring:theme code="product.share.email"/>"
				title="<spring:theme code="product.share.email"/>">
			</a>
        	<a class="addthis_button_compact">
			</a>
        	<a class="addthis_counter addthis_bubble_style"
        		alt="<spring:theme code="product.share.viewMoreServices"/>"
				title="<spring:theme code="product.share.viewMoreServices"/>">
			</a>
		</div>       
		<script
			src="http://s7.addthis.com/js/300/addthis_widget.js#pub=xa-4afd47c25121d881"
