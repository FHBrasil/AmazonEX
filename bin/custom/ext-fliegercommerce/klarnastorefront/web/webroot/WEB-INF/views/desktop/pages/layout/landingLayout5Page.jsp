...
<template:page pageTitle="${pageTitle}">
	...
	<div class="span-24">
		<div class="span-4 section3 cms_banner_slot">
			<cms:slot var="feature" contentSlot="${slots.Section3}">
				<cms:component component="${feature}"/>
			</cms:slot>
		</div>
		<div class="span-20 last">
			<div class="span-20 section2 cms_banner_slot">
			...
			<div class="span-20 last">
				<cms:slot var="feature" contentSlot="${slots.Section4}">
					<div class="span-4 section4 small_detail ${(elementPos%4 == 3) ? 'last' : ''}">
						<cms:component component="${feature}"/>
					</div>
				</cms:slot>
			</div>
			<div class="span-20 section5 cms_banner_slot last">
