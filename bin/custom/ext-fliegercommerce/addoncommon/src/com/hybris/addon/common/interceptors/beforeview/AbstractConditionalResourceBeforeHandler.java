 ...
 * 
 */
package com.hybris.addon.common.interceptors.beforeview;
...
public abstract class AbstractConditionalResourceBeforeHandler implements BeforeViewHandlerAdaptee {
	...
	protected void addOrAppendListAttribute(ModelMap model, final String key, List newVals)
	{
		final List vals;
	...
	protected abstract boolean isIncludeResource(HttpServletRequest request, HttpServletResponse response, ModelMap model, String viewName);
