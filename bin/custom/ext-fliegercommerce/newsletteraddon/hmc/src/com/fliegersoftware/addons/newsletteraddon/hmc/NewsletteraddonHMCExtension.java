 ...
 *  
 */
package com.fliegersoftware.addons.newsletteraddon.hmc;
...
/**
 * Provides necessary meta information about the newsletteraddon hmc extension.
 * 
 * 
 * @version ExtGen v5.4.0.1
 */
public class NewsletteraddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(NewsletteraddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.fliegersoftware.addons.newsletteraddon.hmc.locales";
