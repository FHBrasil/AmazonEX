 ...
 *  
 */
package com.fliegersoftware.addons.newsletteraddon.jalo;
...
import com.fliegersoftware.addons.newsletteraddon.constants.NewsletteraddonConstants;



/**
 * This is the extension manager of the Newsletteraddon extension.
 */
public class NewsletteraddonManager extends GeneratedNewsletteraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NewsletteraddonManager.class.getName());
	 ...
	 */
	public static NewsletteraddonManager getInstance()
	{
		return (NewsletteraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NewsletteraddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewsletteraddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NewsletteraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NewsletteraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NewsletteraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
