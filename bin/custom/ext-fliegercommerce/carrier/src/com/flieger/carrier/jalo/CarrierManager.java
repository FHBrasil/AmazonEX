...
/**
 * This is the extension manager of the Carrier extension.
 */
public class CarrierManager extends GeneratedCarrierManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CarrierManager.class.getName());
	...
	{
		return (CarrierManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CarrierConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CarrierManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CarrierManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CarrierManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CarrierManager called, current tenant: " + getTenant().getTenantID());
		}
	}
