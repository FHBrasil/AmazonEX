 ...
 * @author jfelipe
 */
public class OrderHeaderForCustomerPixiApiImporter extends
		AbstractPixiApiImporter {

	private static final Logger LOG = Logger
			.getLogger(OrderHeaderForCustomerPixiApiImporter.class);
	//
	...
	private List<OrderHeaderResult> importOrderHeaderForCustomer(
		...
		SOAPMessage request = getPixiSoapApi()
				.buildMessage(PixiFunction.GET_ORDER_HEADERS_FOR_CUSTOMER,
						functionParameters);
