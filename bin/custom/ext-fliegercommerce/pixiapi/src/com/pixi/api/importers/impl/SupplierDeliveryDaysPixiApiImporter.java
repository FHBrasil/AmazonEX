 ...
 * @author jfelipe
 */
public class SupplierDeliveryDaysPixiApiImporter extends
        AbstractPixiApiImporter {
    
    private static final Logger LOG = Logger
            .getLogger(SupplierDeliveryDaysPixiApiImporter.class.getName());
     ...
     * @return A XML Node containing the <SOrderKey> tags.
    ...
    private List<IntegerResult> importDefaultDeliveryDays(
        ...
        try {
            request = getPixiSoapApi().buildMessage(
                    PixiFunction.GET_SUPPLIERS_DEFAULT_DELIVERY_DAYS,
                    functionParameters);
