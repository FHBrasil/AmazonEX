...
public class OrderLinePixiApiImporter extends AbstractPixiApiImporter {
    ...
    private static final Logger LOG = Logger
            .getLogger(OrderLinePixiApiImporter.class);
    //
     ...
     * @return A List of {@link OrderLineResult} containing the results from
     *         Pixi API
     ...
     */
    @Override
    public List<OrderLineResult> importData(
     ...
     * @throws KeyManagementException
     */
    private List<OrderLineResult> importOrderLines(
            List<PixiFunctionParameter> functionParameters) {
        ...
        try {
            request = getPixiSoapApi().buildMessage(
                    PixiFunction.GET_ORDER_LINE, functionParameters);
