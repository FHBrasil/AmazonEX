...
/**
 * This is the extension manager of the Amazonloginaddon extension.
 */
public class AmazonloginaddonManager extends GeneratedAmazonloginaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmazonloginaddonManager.class.getName());
	 ...
	 */
	public static AmazonloginaddonManager getInstance()
	{
		return (AmazonloginaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonloginaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonloginaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonloginaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonloginaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonloginaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
