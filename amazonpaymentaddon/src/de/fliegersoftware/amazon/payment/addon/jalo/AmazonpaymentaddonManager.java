...
/**
 * This is the extension manager of the Amazonpaymentaddon extension.
 */
public class AmazonpaymentaddonManager extends GeneratedAmazonpaymentaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AmazonpaymentaddonManager.class.getName());
	 ...
	 */
	public static AmazonpaymentaddonManager getInstance()
	{
		return (AmazonpaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AmazonpaymentaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmazonpaymentaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmazonpaymentaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmazonpaymentaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmazonpaymentaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
